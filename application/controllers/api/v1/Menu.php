	...
	public function onGetMenues(){
		...
		if(!empty($json_data)){
			...
			if($decoded!='' || $decoded!=NULL){
				$country_code 	= 	clean_json_data($decoded->country_code);

				$country=$this->com->get_country(array('country_iso_code_2'=>strtoupper($country_code)));
			...
			$return['success']='1';
			$return['top_menues']=$main_menues;
        	$return['top_menu_footer_ads_heading']=$footer_ads_heading;
        	$return['top_menu_footer_ads']=$footer_ads;
