...
class Courses  extends BaseFrontController{
	...
	public function index(){
		...
		$this->theme->title($this->data['page_title'])->load('search/vw_search_courses_page', $this->data);
	}
	...
	public function indexCourseStreamDetails(){
		...
		if((is_string($slug_1) && $slug_1=='courses') && (is_string($slug_2) && $slug_2!='0')){
			...
			if(!empty($stream_slug_data) && $stream_slug_data->slug_type=='3'){
				...
				$menues=$this->sm->get_menues(array('menu_link_type'=>'13','menu_is_inner'=>'1','menu_link_id'=>$stream_slug_data->slug_type_id,'menu_parent_id'=>'0'),FALSE);
				...
				$this->theme->title($this->data['page_title'])->add_partial('partial_apply_through_stream_page_modal')->add_partial('partial_ask_question_of_courses_modal')->load('webpage/streams/vw_streams_details', $this->data);
				...
				$menues=$this->sm->get_menues(array('menu_link_id'=>$stream_slug_data->slug_type_id,'menu_link_type'=>'10','menu_is_inner'=>'1','menu_category_id'=>'5'),FALSE);
				...
				$this->theme->title($this->data['page_title'])->load('webpage/streams/vw_streams_course_details', $this->data);
			...
			if(!empty($course_slug)){
				...
				**/
				...
				if($slug_type=='3'){ //stream
					...
					$menues=$this->sm->get_menues_specific($menues_fields,array('menu_link_id'=>$stream_data->stream_id,'menu_link_type'=>'13','menu_is_inner'=>'1'),FALSE);
					...
					$menues=$this->sm->get_menues_specific($menues_fields,array('menu_link_id'=>$course_slug->slug_type_id,'menu_link_type'=>'20','menu_is_inner'=>'1','menu_category_id'=>'5'),FALSE);
