...
class Colleges extends BaseFrontController
{
	...
	public function indexPublicPages(){
		...
		if(!empty($url_data)){
			...
			if(!empty($college_data)){
				$menu_link_type=($college_data->college_utype==4)?'10':'101';
				...
				$data=array(
					...
					'college_user_type'=>($college_data->college_type==7)?'2':'1',
				...
				//print_obj($this->data['page_structure_data']);die;
				...
				// }else if($college_data->college_utype=='6'){
