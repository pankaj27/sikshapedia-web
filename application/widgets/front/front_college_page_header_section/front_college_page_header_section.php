        ...
        */
        ...
        if(session_userdata('isUserLoggedin') && session_userdata('user_id')){
            ...
            array_unshift( $__inner_menu,array(
                    ...
                    'menu_name'=>'Enquiries',
                    'menu_link'=>base_url().'account/enquiries',
                    'menu_default_active'=>'',
                    'menu_active'=>($segment_2!='0' && $segment_2=='enquiries')?'active':''
                ),array(
                    'menu_name'=>'Reviews',
                    'menu_link'=>base_url().'account/reviews',
                    'menu_default_active'=>'',
                    'menu_active'=>($segment_2!='0' && $segment_2=='reviews')?'active':''
                ),array(
                    'menu_name'=>'Leads',
                    'menu_link'=>base_url().'account/leads',
                    'menu_default_active'=>'',
                    'menu_active'=>($segment_2!='0' && $segment_2=='leads')?'active':''
                ),array(
                    'menu_name'=>'Logout',
                    'menu_link'=>base_url().'account/logout',
                    'menu_default_active'=>'',
                    'menu_active'=>''
                ));
        }
