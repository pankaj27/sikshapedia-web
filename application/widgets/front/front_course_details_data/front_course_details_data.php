...
class Front_course_details_data extends Widget
{
    function run($visible = FALSE,$course_id=0,$menu_id=0,$menu_slug='overview') {
        ...
        $menues_fields='menu_id,menu_name,menu_column_id,menu_is_top,menu_is_active,menu_parent_id,menu_serial,menu_link_id,menu_link_type,menu_link,menu_slug';

        $menu_data=$this->sm->get_menues_specific($menues_fields,array('menu_link_type'=>'20','menu_is_inner'=>'1','menu_link_id'=>$course_id,'menu_id'=>$menu_id),FALSE,'menu_serial','ASC',FALSE);
