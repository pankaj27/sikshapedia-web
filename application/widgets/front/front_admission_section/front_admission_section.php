...
class Front_admission_section extends Widget
{
	...
	function run($visible = FALSE,$ids=null) {
     ...
     $show_curator_image=$ids['show_curator_image'];
     ...
     $system_name=$this->data['system_title_name'];
      ...
      $uploaded_by=$this->um->_get_internal_user(array('user_id'=>$info->info_creator_id));
    	...
    	//if(!empty($country_data)){
    		   //$infos_data=$this->im->__get_inst_info_data(array('info_type'=>'2','info_type_2'=>'admission_info','info_type_id'=>$college_id),array('info_type!='=>'2'),'info_serial','ASC',FALSE);

        $infos_intro_data=$this->im->get_inst_info_data(array('info_type'=>'2','info_type_2'=>'general_info','info_value_type'=>'2','info_type_id'=>$college_id));

        $infos_data=$this->im->__get_inst_info_data(array('info_type'=>'2','info_type_2'=>'admission_info','info_type_id'=>$college_id),null,'info_serial','ASC',FALSE);
      ...
      $info=$this->im->get_inst_info_data(array('info_type_2'=>'admission_info','info_type_id'=>$college_id));
      ...
      $data=array(
         ...
         'college_admission_intro'=>$infos_intro_data->info_value_admission_intro
      );
