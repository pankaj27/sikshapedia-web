							...
							foreach ($exams as $key => $value) {
								...
								if($exam_year_data->exam_start_date!=null){
									...
									if($exam_year_data->exam_end_date!=null){
										if((strtotime($exam_year_data->exam_start_date)>=strtotime($current_date)) && (strtotime($current_date)<=strtotime($exam_year_data->exam_end_date))){
											$dates_active='1';
										}else{
											$dates_active='2';
										}
									}else{
										if((strtotime($exam_year_data->exam_start_date)>=strtotime($current_date))){
											$dates_active='1';
										}else{
											$dates_active='2';
										}
