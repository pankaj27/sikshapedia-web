...
class Front_google_ads_section extends Widget
{
    ...
    function run($visible = FALSE,$ads_param=null){
        $this->front_theme='default';
        $this->get_type(2);

        $data['ads_type']=$ads_param['ads_type'];
        $data['ca_pub']=$ads_param['ca_pub'];
        $data['ad_slot']=$ads_param['ad_slot'];

        $data['ad_format']=$ads_param['ad_format'];
        $data['ad_responsive']=$ads_param['ad_responsive'];
