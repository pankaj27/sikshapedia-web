 ...
 * 
 */
class Front_college_settings_edit_section extends Widget
{
	...
	function run($visible = FALSE) {
       ...
       // print_obj($college_data);die;
        ...
        $_cities=$this->com->get_city(array('city_country_id'=>$college_data->college_country_id,'city_state_id'=>$college_data->college_state_id),FALSE,$order_by=null,$order='ASC');
        ...
        if ($visible) $this->render('front_college_settings_edit_section',$data);
    }
}