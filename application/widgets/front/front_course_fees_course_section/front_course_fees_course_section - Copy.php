...
class Front_course_fees_course_section extends Widget
{
	function run($visible = FALSE){
        ...
        if((is_string($segment_1) && $segment_1!='0') && (is_string($segment_2) && $segment_2!='0') && (is_string($segment_3) && $segment_3!='0' && $segment_3=='course-fees') && $segment_4!='0'){
        		...
        		if(!empty($slug_found)){
					...
					if($slug_type=='6'){//University
						...
						if(!empty($_college_data)){
							...
							$_course_data = $this->im->get_user_course(array('user_type'=>'4','user_id'=>$slug_type_id,'user_course'=>$slug4_type_id),FALSE);
