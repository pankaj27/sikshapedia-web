	...
	function run($visible = FALSE,$ids=null){
        ...
        if($_college_data->college_web_address!=NULL){
          ...
          $college_highlights=array(                
    		...
    		$info=$this->im->get_inst_info_data(array('info_type_id'=>$college_id,'info_type_2'=>'general_info','info_type'=>'2','info_value_type'=>'2'));
        ...
        $college_faqs=$this->sm->get_system_users_faqs_data(array('faq_data_id'=>$college_id,'faq_data_id_type'=>'2','faq_type'=>'1'),FALSE);
        ...
        $college_ranking_data=$this->im->_get_inst_ranking_data(array('ranking_inst_type'=>'college','ranking_inst_id'=>$college_id));
        ...
        if(!empty($_course_fees_data)){
          foreach ($_course_fees_data as $key => $value) {
            $user_course_streams=$this->strm->get_group_concat_user_course_stream_data('stream_name',array('user_id'=>$college_id,'course_id'=>$value->user_course_id),FALSE);
