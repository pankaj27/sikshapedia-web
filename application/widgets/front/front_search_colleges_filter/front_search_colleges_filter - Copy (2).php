    	...
    	if(isset($slug_3)){
    		if(!empty($slug_data_3)){
    			if($slug_data_3->slug_type=='1'){
					$country_cities=$this->com->__get_city('city_id,city_name,city_name_slug,city_name_state_slug',array('city_country_id'=>$country_id,'city_state_id'=>$slug_data_3->slug_type_id,'city_status'=>'1'),FALSE,'city_serial','ASC');
    			}else{
    				$country_cities=$this->com->__get_city('city_id,city_name,city_name_slug,city_name_state_slug',array('city_country_id'=>$country_id,'city_status'=>'1'),FALSE,'city_serial','ASC');
    			}
