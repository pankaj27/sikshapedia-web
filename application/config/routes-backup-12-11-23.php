...
$route[$base_url.'/institutions/load_inner_menu_form_data']			=	'admin/Institutions/onGenerateCollegeMenuStructureData';
...
$route['reviews/write/(:any)/(:any)/(:any)']	=	'front/Reviews/indexWriteReview';
