...
$route['account/favourite-colleges']		=	'front/User/indexStudentPage';
$route['account/my-reviews']				=	'front/User/indexStudentPage';

$route['account/applicant_listing']			=	'front/User/onLoadEnquireies';
$route['account/leads_listing']				=	'front/User/onLoadCollegeLeads';
$route['leads_listing_remarks_add']		    =	'front/User/onUpdateLeadsStatus';
$route['leads_listing_remarks_status_list'] =	'front/User/onLoadLeadsStatus';
...
//CRON
$route['cronmail']			=	'Crons/cronEmailCampaign';
$route['croncityaddremovefilter']			=	'cron/Crons/cronAddRemoveCityFromSearch';
$route['cronaddsearchdata']			=	'cron/Crons/cronCreateSearchData';
...
$route[$base_url.'/settings/update_editor_version']	=	'admin/Settings/onUpdateEditorVersion';
...
$route[$base_url.'/emailcampaigns']					=	'admin/Campaigns/index';
$route[$base_url.'/emailcampaigns/add']				=	'admin/Campaigns/indexAddEditCampaigns';
$route[$base_url.'/emailcampaigns/add/(:any)']		=	'admin/Campaigns/indexAddEditCampaigns/$1';
$route[$base_url.'/search_campaignsinstitutions']	=	'admin/Campaigns/onSearchInstitutions';
$route[$base_url.'/search_emailcampaigns']			=	'admin/Campaigns/onSearchCampaigns';
$route[$base_url.'/search_emailcampaigns_data']		=	'admin/Campaigns/onSearchCampaignMail';
$route[$base_url.'/send_emailcampaigns']			=	'admin/Campaigns/onSendCampaignMail';
$route[$base_url.'/create_emailcampaigns']			=	'admin/Campaigns/onAddEditCampaign';
...
$route[$base_url.'/institutions/studycenters']						=	'admin/Institutions/indexStudyCenters';
$route[$base_url.'/institutions/collegesdata']						=	'admin/Institutions/indexCollegesData';

$route[$base_url.'/institutions/update_user_course_streams']		=	'admin/Institutions/update_user_course_streams';
$route[$base_url.'/institutions/update_user_images']				=	'admin/Institutions/update_college_logo_banner_path';
$route[$base_url.'/institutions/_update_user_images']				=	'admin/Institutions/onUpdateCollegeLogoBanners';
$route[$base_url.'/institutions/update_user_stream_data']			=	'admin/Institutions/update_college_stream_course_data';
$route[$base_url.'/institutions/_update_user_stream_data']			=	'admin/Institutions/onUpdateCollegeStreamsCourse';
$route[$base_url.'/institutions/_update_user_data']				    =	'admin/Institutions/onCreateCollegeNewUser';
$route[$base_url.'/institutions/_update_college_top_position']		=	'admin/Institutions/onUpdateTopListColleges';
$route[$base_url.'/institutions/_delete_college_rank']				=	'admin/Institutions/onDeleteCollegeRanks';

$route[$base_url.'/institutions/_delete_cache']						=	'admin/Institutions/onUpdateCache';

$route[$base_url.'/institutions/update_search_data']				=	'admin/Institutions/import_search_data';
...
$route[$base_url.'/institutions/leads']							=	'admin/Institutions/indexLeads';
$route[$base_url.'/institutions/leads_search']					=	'admin/Institutions/onSearcheLeads';
...
$route[$base_url.'/institutions/get_leads_course_list']				=	'admin/Institutions/onLoadLeadsCourses';
...
$route[$base_url.'/streams_course_edit_form']			=	'admin/Streams/onLoadCourseEditForm';
$route[$base_url.'/streams_colleges_edit_form']			=	'admin/Streams/onLoadStreamCollegesEditForm';
$route[$base_url.'/streams_colleges_edit_form_update']	=	'admin/Streams/onUpdateStreamTaggedColleges';
...
$route[$base_url.'/streams/move_stream']		=	'admin/Streams/onMoveToSubStream';
...
$route[$base_url.'/ads/getadssearchpages']			=	'admin/Ads/onGetSearchPages';
$route[$base_url.'/ads/getadscollegepages']			=	'admin/Ads/onGetCollgesPages';
...
$route[$base_url.'/seo/colleges/add_logo_banner_meta']		=	'admin/SEO/onUpdateFileMeta';
...
$route[$base_url.'/seo/update_college_list_order']	=	'admin/SEO/onUpdateCollegeSearchListOrder';
...
$route[$base_url.'/seo/update_college_slug_data']	=	'admin/SEO/onUrlParameters';
...
$route[$base_url.'/seo/urlchecker']								=	'admin/SEO/indexURLChecker';
$route[$base_url.'/seo/urlchecker_search']						=	'admin/SEO/onSearchURLChecker';
$route[$base_url.'/seo/urlchecker_meta_load']					=	'admin/SEO/onLoadURLMetadata';




$route[$base_url.'/seo/fileeditor']								=	'admin/SEO/indexFileeditor';
$route[$base_url.'/seo/update_fileeditor_data']					=	'admin/SEO/onUpdateRobotsTxt';
...
$route[$base_url.'/blogs_add_new']		=	'admin/Blogs/onAddEditBlog';
...
$route['signin/institutions']				=	'front/User/indexSigninInstitutions';
...
$route['instlogin']							=	'front/User/onLoginInstUser';
...
$route['__get_cities']						=	'front/Common/__onGetCities';
...
$route['reviews/searchcollege']             =	'front/Reviews/onLoadReviewCollegeList';    
...
$route['exams_search']							=	'front/Exams/onLoadExamsList';
...
/**Study center Search Page */
$route['study-center']								=	'front/Studycenters/index';
$route['(:any)/study-center']						=	'front/Studycenters/index';
$route['(:any)/study-center/(:any)']				=	'front/Studycenters/index/$1';
$route['(:any)/study-center/(:any)/(:any)']			=	'front/Studycenters/index/$1/$2';
$route['(:any)/study-center/(:any)/(:any)/(:any)']	=	'front/Studycenters/index/$1/$2/$3';
$route['(:any)/study-center/(:any)/(:any)/(:any)/(:any)']	=	'front/Studycenters/index/$1/$2/$3/$4';
...
$route['add_college_favourite']					=	'front/Common/onAddFavourite';
$route['add_college_compare']					=	'front/Common/onAddCompare';
$route['del_college_compare']					=	'front/Common/onDeleteCompare';
...
$route['privacy-policy']						=	'front/Common/indexPrivacyPolicy';
...
$route['account-close']						=	'front/User/indexRemoveAccountRequest';
