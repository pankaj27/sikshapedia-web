...
class User_model extends BaseModel
{
    ...
    public function store_listing_package_users($data,$return_query=FALSE){
	...
	public function _get_applicants($post=array(),$param=array(),$count=FALSE,$return_query=FALSE){
		$this->db->select(
			'system_applicant.*,system_country.country_name,system_country_cities.city_name,system_courses.course_name'
		);
