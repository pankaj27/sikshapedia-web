...
class Settings_model extends BaseModel
{
    ...
    public function _get_files($post=array(),$param=array(),$count=FALSE,$return_query=FALSE){
        ...
        if(isset($post['parent_folder']) && !empty($post['parent_folder'])){
            $this->db->where('storage_parent_id',$post['parent_folder']);
        }
    ...
    public function get_menue($param,$return_query=FALSE){
        $this->table='system_menu';
        return $this->get_one($param,'',$return_query);      
    }
    ...
    public function get_slug($param,$single_row=TRUE,$order_by=null,$order='DESC',$return_query=FALSE){
     ...
     public function __get_slug($fields,$param,$single_row=TRUE,$order_by=null,$order='DESC',$return_query=FALSE){
        $this->table='system_slugs';
        if($single_row==TRUE){
            return $this->get_one_specific($fields,$param,'',$return_query);
        }else if($single_row==FALSE){
    ...
    public function _get_slugs_urls($post=array(),$param=array(),$count=FALSE,$return_query=FALSE){
        ...
        if(isset($param['url_stream']) && $param['url_stream']!=NULL){
            $this->db->where('url_stream',$param['url_stream']);
        }
    ...
    public function _get_slug_struct_data($fields,$param,$single_row=TRUE,$order_by=null,$order='DESC',$return_query=FALSE){
        $this->table='system_slugs_urls_struct_data';
        if($single_row==TRUE){
            return $this->get_one_specific($fields,$param,'',$return_query);
        }else if($single_row==FALSE){
    ...
    public function ____get_system_search_data($searched_param,$limit=20,$start=0,$return_query=FALSE){
        // $sql ="SELECT `search_data_id`,`search_data_short_name`, `search_data_type_id`, `search_data_type`, `search_data_name`,`search_data_meta_keywords` ,`search_data_access_url`,`search_storage_access_url`,`search_data_country`,`search_data_state_name`,`search_data_city_name`,`search_data_address`,`search_country_logo_url` FROM `way2_system_data_search` WHERE MATCH(`search_data_type`,`search_data_name`,`search_data_short_name`,`search_data_country`,`search_data_state_name`,`search_data_city_name`,`search_data_address`,`search_data_course_name`,`search_data_course_short_name`,`search_data_stream_name`,`search_data_exam_name`,`search_data_meta_title`,`search_data_meta_desc`,`search_data_meta_keywords`) AGAINST(".$this->db->escape($searched_param)." IN NATURAL LANGUAGE MODE) AND (`search_data_type` = 'COLLEGE_NAME' OR `search_data_type` = 'UNIVERSITY_NAME' OR `search_data_type` = 'EXAM_NAME' OR `search_data_type` = 'COURSE_NAME' OR `search_data_type` = 'COURSE_CUSTOM_NAME' OR `search_data_type` = 'BLOG_POST' OR `search_data_type` = 'STREAM_MENU_NAME') ORDER BY `search_data_id` ASC";

        $sql ="SELECT `search_data_id`,`search_data_id`,`search_data_short_name`, `search_data_type_id`, `search_data_type`, `search_data_name`,`search_data_meta_keywords` ,`search_data_access_url`,`search_storage_access_url`,`search_data_country`,`search_data_state_name`,`search_data_city_name`,`search_data_address`,`search_country_logo_url` FROM `way2_system_data_search` WHERE `search_data_type` LIKE '%".$searched_param."%' OR `search_data_name` LIKE '%".$searched_param."%' OR`search_data_short_name` LIKE '%".$searched_param."%' OR `search_data_country` LIKE '%".$searched_param."%' OR `search_data_state_name`  LIKE '%".$searched_param."%' OR `search_data_city_name`  LIKE '%".$searched_param."%' OR `search_data_address`  LIKE '%".$searched_param."%' OR `search_data_course_name`  LIKE '%".$searched_param."%' OR `search_data_course_short_name`  LIKE '%".$searched_param."%'OR `search_data_stream_name`  LIKE '%".$searched_param."%' OR `search_data_exam_name` LIKE '%".$searched_param."%' OR `search_data_meta_title` LIKE '%".$searched_param."%' OR `search_data_meta_desc` LIKE '%".$searched_param."%' OR `search_data_meta_keywords` AND (`search_data_type` = 'COLLEGE_NAME' OR `search_data_type` = 'UNIVERSITY_NAME' OR `search_data_type` = 'EXAM_NAME' OR `search_data_type` = 'COURSE_NAME' OR `search_data_type` = 'COURSE_CUSTOM_NAME' OR `search_data_type` = 'BLOG_POST' OR `search_data_type` = 'STREAM_MENU_NAME') ORDER BY `search_data_id` ASC";
    ...
    public function update_edu_details($data,$param,$batch=FALSE,$return_query=FALSE){
     ...
     public function get_school_edu_details($param,$single_row=TRUE,$return_query=FALSE){
        $this->table='system_users_schooling_details';
        if($single_row==TRUE){
            return $this->get_one($param,$return_query);
        }else if($single_row==FALSE){
            return $this->get_many($param,$return_query);
    ...
    public function store_school_edu_details($data,$return_query=FALSE){
        $this->table='system_users_schooling_details';
        return $this->store($data,FALSE,$return_query);
    }

    public function delete_school_edu_details($param,$return_query=FALSE){
        $this->table='system_users_schooling_details';
        return $this->remove($param,0,$return_query);
    }

    public function update_school_edu_details($data,$param,$batch=FALSE,$return_query=FALSE){
        $this->table='system_users_schooling_details';
        return $this->modify($data,$param,$batch,$return_query);
    }
    ...
    public function get_total_review_status_data($param=null,$return_query=FALSE){
        $this->table='system_institute_reviews_status';
        return $this->get_total_count($param,$return_query);
    }
    ...
    public function delete_review_data($param,$soft_delete=FALSE,$deleted_by=0,$return_query=FALSE){
        $this->table='system_institute_reviews_data';
        if($soft_delete==FALSE){
            return $this->remove($param);
        }else if($soft_delete==TRUE){
    ...
    public function get_review_datas($post=array(),$param=array(),$return_query=FALSE){
        $this->db->select('system_institute_reviews_data.*,system_users_colleges.college_user_id,system_users_colleges.college_name,system_users_colleges.college_short_name,system_users_colleges.college_utype');
    ...
    public function _get_review_data($post=array(),$param=array(),$group_by=FALSE,$count=FALSE,$return_query=FALSE){
        ...
        if(isset($param['review_user_anonymus_id']) && $param['review_user_anonymus_id']==true){
            $this->db->where('review_user_anonymus_id!=','0');
        }
    ...
    public function delete_review_question_data($param,$soft_delete=FALSE,$deleted_by=0,$return_query=FALSE){
        $this->table='system_institute_reviews_question_data';
        if($soft_delete==FALSE){
            return $this->remove($param);
        }else if($soft_delete==TRUE){
    ...
    public function get_total_rating($param,$return_query=FALSE){

        $this->db->select('ROUND(((SUM(review_question_rating / 10) / COUNT(review_question_rating)) * 10), 1) as rating');
        $this->db->where($param);
        $query=$this->db->get('system_institute_reviews_question_data');
    ...
    public function get_total_average_rating($college_id,$return_query=FALSE){
        $sql='SELECT ROUND((((SUM(user_avg_rating)/10)/COUNT(user_avg_rating))*10), 1) as total_average_rating
        FROM (
          SELECT review_user_anonymusid, ROUND(((SUM(review_question_rating / 10) / COUNT(review_question_rating)) * 10), 1) as user_avg_rating FROM `way2_system_institute_reviews_question_data`  WHERE review_inst_id='.$college_id.' GROUP BY review_user_anonymusid
        ) as user_ratings';
    ...
    public function get_review_status_data($param,$single_row=TRUE,$group_by='',$return_query=FALSE){
        $this->table='system_institute_reviews_status';
        if($single_row==TRUE){
            return $this->get_one($param,$group_by,$return_query);
        }else if($single_row==FALSE){
    ...
    public function add_review_status_data($data,$batch=FALSE,$return_query=FALSE){
        $this->table='system_institute_reviews_status';
        return $this->store($data,$batch,$return_query);
    }


    public function update_review_status_data($data,$param,$batch=FALSE,$return_query=FALSE){
        $this->table='system_institute_reviews_status';
        return $this->modify($data,$param,$batch,$return_query);
    }

    public function delete_review_status_data($param,$soft_delete=FALSE,$deleted_by=0,$return_query=FALSE){
        $this->table='system_institute_reviews_status';
        if($soft_delete==FALSE){
            return $this->remove($param);
        }else if($soft_delete==TRUE){
    ...
    public function _get_review_status_data($post=array(),$param=array(),$count=FALSE,$return_query=FALSE){

        $this->db->select('system_institute_reviews_status.*,system_institute_reviews_data.*');
        $this->db->join('system_institute_reviews_data','system_institute_reviews_data.review_unique_id=system_institute_reviews_status.review_uid','LEFT');
        
        $i = 0;

        if(isset($param['review_inst_id']) && is_numeric($param['review_inst_id'])){
            $this->db->where('system_institute_reviews_status.review_inst_id',$param['review_inst_id']);
        }

        if(isset($param['review_approved'])){
            $this->db->where('system_institute_reviews_status.review_approved',$param['review_approved']);
        }
        ...
        if($count==FALSE){
            ...
            $query = $this->db->get('system_institute_reviews_status');
    ...
    //File Update
    public function get_file_access_data($param,$single_row=TRUE,$return_query=FALSE){
        $this->table='system_file_data';
        if($single_row==TRUE){
            return $this->get_one($param,$return_query);
        }else if($single_row==FALSE){
            return $this->get_many($param,$return_query);
    ...
    public function store_file_access_data($data,$return_query=FALSE){
        $this->table='system_file_data';
        return $this->store($data,FALSE,$return_query);
    }

    public function delete_file_access_data($param,$return_query=FALSE){
        $this->table='system_file_data';
        return $this->remove($param,0,$return_query);
    }

    public function update_file_access_data($data,$param,$return_query=FALSE){
        $this->table='system_file_data';
        return $this->modify($data,$param,FALSE,$return_query);
    }
    ...
    //Email Campaigns
    public function store_campaigns($data,$return_query=FALSE){
        $this->table='system_campaigns';
        return $this->store($data,FALSE,$return_query);
    }

    public function delete_campaigns($param,$return_query=FALSE){
        $this->table='system_campaigns';
        return $this->remove($param,0,$return_query);
    }

    public function update_campaigns($data,$param,$return_query=FALSE){
        $this->table='system_campaigns';
        return $this->modify($data,$param,FALSE,$return_query);
    }

    public function get_campaigns($param,$single_row=TRUE,$fields=null,$return_query=FALSE){
        $this->table='system_campaigns';
        if($single_row==TRUE){
            if($fields!=null){
              return $this->get_one_specific($fields,$param,'',$return_query);
    ...
    public function __get_campaigns($param,$single_row=TRUE,$return_query=FALSE){
        $this->db->select('system_campaigns.*,system_email_templates.*');
        $this->db->join('system_email_templates','system_email_templates.template_id=system_campaigns.campaign_template','LEFT');

        $this->db->where($param);

        $query=$this->db->get('system_campaigns');
        if($return_query==FALSE){
            if($single_row==TRUE){
                return $query->first_row();
            }else{
    ...
    public function _get_campaigns($post=array(),$param=array(),$count=FALSE,$return_query=FALSE){
       $this->db->select('system_campaigns.*,system_email_templates.*');
       $this->db->join('system_email_templates','system_email_templates.template_id=system_campaigns.campaign_template','LEFT');
    ...
    //Email Templates
    public function store_campaigns_mails($data,$bulk=FALSE,$return_query=FALSE){
        $this->table='system_campaigns_mails';
        return $this->store($data,$bulk,$return_query);
    }

    public function delete_campaigns_mails($param,$return_query=FALSE){
        $this->table='system_campaigns_mails';
        return $this->remove($param,0,$return_query);
    }

    public function update_campaigns_mails($data,$param,$return_query=FALSE){
        $this->table='system_campaigns_mails';
        return $this->modify($data,$param,FALSE,$return_query);
    }

    public function get_campaigns_mails($param,$single_row=TRUE,$fields=null,$return_query=FALSE){
        $this->table='system_campaigns_mails';
        if($single_row==TRUE){
            if($fields!=null){
              return $this->get_one_specific($fields,$param,'',$return_query);
    ...
    public function _get_campaigns_mails($post=array(),$param=array(),$count=FALSE,$return_query=FALSE){
        $this->db->select('system_campaigns_mails.*');
        ...
        if($count==FALSE){
            ...
            $query = $this->db->get('system_campaigns_mails');
    ...
    public function store_campaigns_mail_logs($data,$return_query=FALSE){
        $this->table='system_campaigns_logs';
        return $this->store($data,FALSE,$return_query);
    }

    public function delete_campaigns_mail_logs($param,$return_query=FALSE){
        $this->table='system_campaigns_logs';
        return $this->remove($param,0,$return_query);
    }

    public function update_campaigns_mail_logs($data,$param,$return_query=FALSE){
        $this->table='system_campaigns_logs';
        return $this->modify($data,$param,FALSE,$return_query);
    }

    public function get_campaigns_mail_logs($param,$single_row=TRUE,$fields=null,$return_query=FALSE){
        $this->table='system_campaigns_logs';
        if($single_row==TRUE){
            if($fields!=null){
              return $this->get_one_specific($fields,$param,'',$return_query);
    ...
    //****//
     ...
     //Email Templates
    public function store_email_template($data,$return_query=FALSE){
        $this->table='system_email_templates';
        return $this->store($data,FALSE,$return_query);
    }

    public function delete_email_template($param,$return_query=FALSE){
        $this->table='system_email_templates';
        return $this->remove($param,0,$return_query);
    }

    public function update_email_template($data,$param,$return_query=FALSE){
        $this->table='system_email_templates';
        return $this->modify($data,$param,FALSE,$return_query);
    }

    public function get_template($param,$single_row=TRUE,$fields=null,$return_query=FALSE){
        $this->table='system_email_templates';
        if($single_row==TRUE){
            if($fields!=null){
              return $this->get_one_specific($fields,$param,'',$return_query);
    ...
    public function _get_template($post=array(),$param=array(),$count=FALSE,$return_query=FALSE){
        $this->db->select('system_email_templates.*');
        ...
        if($count==FALSE){
            ...
            $query = $this->db->get('system_email_templates');
    ...
    public function _get_admissions_list($param=null,$order_by=null,$order='DESC',$return_query=FALSE){
        $db=$this->load->database('sks_admission_db', TRUE);
        ...
        if($param==null || empty($param)){
            if($return_query==FALSE){
                ...
                return $db->get('candidates')->result();
            }else{
                if($order_by!=null){
                    $db->order_by($order_by,$order);
                }
            ...
            if($return_query==FALSE){
                ...
                return $db->get_where('candidates',$param)->result();
            }else{
                if($order_by!=null){
                    $db->order_by($order_by,$order);
                }
                $db->get_where('candidates',$param);
                return $db->last_query();
            }
        }
    }

    public function get_admissions_list_old($post=array(),$param=array(),$count=FALSE,$return_query=FALSE){
        $db=$this->load->database('sks_admission_db', TRUE);

        $db->select('candidates.*');

        $db->select('candidates.*,sys_cities.city_name,sys_states.state_name,sys_districts.district_name,sys_courses.course_name');
        $db->join('sys_cities','sys_cities.city_id=sys_candidates.cad_city','LEFT');
        $db->join('sys_states','sys_states.state_id=sys_candidates.cad_state','LEFT');
        $db->join('sys_districts','sys_districts.district_id=sys_candidates.cad_district','LEFT');
        $db->join('sys_courses','sys_courses.course_id=sys_candidates.cad_course','LEFT');
        
        $i = 0;

        if(isset($param['district_id']) && !empty($param['district_id'])){
            //$db->where('cad_stream',$param['stream_id']);
            //$db->where('cad_district',$param['district_id']);
            $db->where('FIND_IN_SET(cad_district,"'.$param['district_id'].'")<>0');
        }

        if(isset($param['stream_id']) && !empty($param['stream_id'])){
            //$db->where('cad_stream',$param['stream_id']);
            $db->where('FIND_IN_SET(cad_stream,"'.$param['stream_id'].'")<>0');
        }

        // if(isset($param['district_id']) && !empty($param['district_id'])){
        //     //$db->where('cad_stream',$param['stream_id']);
        //     $db->where_in('cad_district',$param['district_id']);
        // }
        ...
        if(isset($param['column_search'])){
            foreach ($param['column_search'] as $item)
            {
                if(isset($post['search']['value']) && $post['search']['value'])
                {
                    ...
                    {
                        $db->group_start();
                        $db->like($item, $post['search']['value']);
                    }
                    else
                    {
                        $db->or_like($item, $post['search']['value']);
                    }
        ...
        {
            $column_order=$param['column_order'];
            $db->order_by($column_order[$post['order']['0']['column']], $post['order']['0']['dir']);
        } 
        else if(isset($param['order']))
        {
            $order = $param['order'];
        ...
        if($count==FALSE){
            if(isset($post['length']) && $post['length'] != -1){
                $db->limit($post['length'],$post['start']);   
            }
            
            $query = $db->get('candidates');
    ...
    public function get_admissions_list_old_2($post=array(),$param=array(),$count=FALSE,$return_query=FALSE){
        $db = $this->load->database('sks_admission_db', TRUE);
        ...
        // Ensure the total number of records does not exceed 300
        if(isset($param['total_data_limit'])){
            $db->limit($param['total_data_limit']);
        }
        

        if($count == FALSE){
            if(isset($post['length']) && $post['length'] != -1) {
                $db->limit(min($post['length'], 300), $post['start']);  // Ensure the limit is at most 300
            }
    ...
    public function get_admissions_list($post=array(),$param=array(),$count=FALSE,$return_query=FALSE){
        $db = $this->load->database('sks_admission_db', TRUE);
        ...
        if(isset($param['course_id']) && !empty($param['course_id'])){
            $db->where('FIND_IN_SET(cad_course,"'.$param['course_id'].'")<>0');
        }

        if(isset($param['leads_gender']) && !empty($param['leads_gender'])){
            $db->where('cad_gender',$param['leads_gender']);
        }
        ...
        // Filter records based on created_at date range
        if (isset($param['date_range_start']) && isset($param['date_range_end'])) {
            $db->where('candidates.created_at >=', $param['date_range_start']);
            $db->where('candidates.created_at <=', $param['date_range_end']);
        }else if (!isset($param['date_range_start']) && isset($param['date_range_end'])) {
            $db->where('candidates.created_at <=', $param['date_range_end']);
        }

        if($count == FALSE){
            // Limit to 10 records per day
            if(isset($param['daily_limit']) && $param['daily_limit'] == TRUE){
                $db->limit(10);
            } else {
                if(isset($post['length']) && $post['length'] != -1) {
                    $db->limit(min($post['length'], 300), $post['start']);  // Ensure the limit is at most 300
    ...
    //Leads
   /* public function store_college_leads($data,$return_query=FALSE){
        $this->table='system_college_leads';
        return $this->store($data,FALSE,$return_query);
    }

    public function delete_college_leads($param,$return_query=FALSE){
        $this->table='system_college_leads';
        return $this->remove($param,0,$return_query);
    }

    public function update_college_leads($data,$param,$return_query=FALSE){
        $this->table='system_college_leads';
        return $this->modify($data,$param,FALSE,$return_query);
    }
    ...
    public function get_college_total_leads($param=null,$return_query=FALSE){
        $this->table='system_college_leads';
        return $this->get_total_count($param,NULL,NULL,$return_query);
    }*/

    public function get_college_leads($param,$single_row=TRUE,$fields=null,$return_query=FALSE){
        $this->table='system_college_leads';
        if($single_row==TRUE){
            if($fields!=null){
              return $this->get_one_specific($fields,$param,'',$return_query);
    ...
    public function get_college_leads_remarks($param,$return_query=FALSE){
        $db=$this->load->database('sks_admission_db', TRUE);
        $table='sys_leads_remarks';
        if($param==null || empty($param)){
            if($return_query==FALSE){
                if($order_by!=null){
                    $db->order_by($order_by,$order);
            ...
            if($return_query==FALSE){
                ...
                return $db->get_where($table,$param)->result();
            }else{
                if($order_by!=null){
                    $db->order_by($order_by,$order);
                }
                $db->get_where($table,$param);
                return $db->last_query();
            }
        }       
    }
    ...
    public function store_college_leads_remarks($data,$return_query=FALSE){
        $db=$this->load->database('sks_admission_db', TRUE);
        $table='sys_leads_remarks';
        if($return_query==FALSE){
            if($batch==FALSE){
                ...
                return $db->insert_batch($this->table,$data);
            }   
        }else{
            return $db->set($data)->get_compiled_insert($this->table);
        }
    }

    public function delete_college_leads_remarks($param,$return_query=FALSE){
        $db=$this->load->database('sks_admission_db', TRUE);
        $table='sys_leads_remarks';
        if($return_query==FALSE){
            if($truncate==0){
                ...
                return $db->empty_table($this->table);
            }else if($truncate==2){
                return $db->truncate($this->table);
            }
        }else{
            if($truncate==0){
                $db->delete($this->table,$param);
            }else if($truncate==1){
    ...
    public function update_college_leads_remarks($data,$param,$return_query=FALSE){
        $db=$this->load->database('sks_admission_db', TRUE);
        $table='sys_leads_remarks';
        if(!empty($data) && !empty($param)){
            if($return_query==FALSE){
                if($batch==FALSE){
                    return $db->update($this->table,$data,$param);
                }else{
                    return $db->update_batch($this->table,$data,$param);
                }
            }else{
                if($batch==FALSE){
                    $db->update($this->table,$data,$param);
                }else{
                    $db->update_batch($this->table,$data,$param);
                }
                return $db->last_query();
            }
        }else{
    ...
    public function get_college_leads_cities($param,$return_query=FALSE){
        $db=$this->load->database('sks_admission_db', TRUE);
        $table='sys_cities';
        if($param==null || empty($param)){
            if($return_query==FALSE){
    ...
    public function get_college_leads_districts($param,$order_by=null,$return_query=FALSE){
        $db=$this->load->database('sks_admission_db', TRUE);
        $table='sys_districts';
        if($param==null || empty($param)){
            if($return_query==FALSE){
    ...
    public function get_college_leads_courses($param,$return_query=FALSE){
        $db=$this->load->database('sks_admission_db', TRUE);
        $table='sys_courses';
        $db->select('sys_courses.*');
        $db->where('FIND_IN_SET(sys_courses.course_stream_id,"'.$param.'")<>0');
        $db->where('course_status','active');
        $query=$db->get('sys_courses');
