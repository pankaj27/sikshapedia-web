...
import { 
  ...
  FiTrendingUp, FiCreditCard, FiMail, FiCalendar, FiLayout, FiLock
} from 'react-icons/fi';
  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: 'Quick Action Cards', path: '/admin/quick-action-cards', icon: FiGrid, highlight: true, badge: 'NEW' },
