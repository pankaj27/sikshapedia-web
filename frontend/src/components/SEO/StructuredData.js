...
export const OrganizationSchema = () => {
  const schema = {
    ...
    "name": "admissionbuddy",
    "url": "https://institute-editor.preview.emergentagent.com",
    "logo": "https://institute-editor.preview.emergentagent.com/admissionbuddy-logo.png",
...
export const CollegeSchema = ({ college }) => {
  const schema = {
    ...
    "@type": "EducationalOrganization",
    "name": college.name,
    "url": `https://institute-editor.preview.emergentagent.com/colleges/${college.id}`,
...
export const BreadcrumbSchema = ({ items }) => {
  const schema = {
    ...
    "itemListElement": items.map((item, index) => ({
      ...
      "position": index + 1,
      "name": item.name,
      "item": `https://institute-editor.preview.emergentagent.com${item.url}`
    }))
  };
...
export const WebsiteSchema = () => {
  const schema = {
    ...
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://institute-editor.preview.emergentagent.com/colleges?search={search_term_string}",
