...
export const OrganizationSchema = () => {
  const schema = {
    ...
    "name": "AdmissionBuddy",
    "url": "https://edudashboard-10.preview.emergentagent.com",
    "logo": "https://edudashboard-10.preview.emergentagent.com/admissionbuddy-logo.png",
...
export const CollegeSchema = ({ college }) => {
  const schema = {
    ...
    "@type": "EducationalOrganization",
    "name": college.name,
    "url": `https://edudashboard-10.preview.emergentagent.com/colleges/${college.id}`,
...
export const BreadcrumbSchema = ({ items }) => {
  const schema = {
    ...
    "itemListElement": items.map((item, index) => ({
      ...
      "position": index + 1,
      "name": item.name,
      "item": `https://edudashboard-10.preview.emergentagent.com${item.url}`
    }))
  };
...
export const WebsiteSchema = () => {
  const schema = {
    ...
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://edudashboard-10.preview.emergentagent.com/colleges?search={search_term_string}",
