  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 flex items-center gap-2 px-5 py-3 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all transform hover:scale-105 animate-bounce-slow"
