...
import { FiMapPin, FiStar, FiUser, FiChevronDown, FiChevronUp, FiChevronRight, FiDownload, FiCheckCircle, FiPhone, FiMail, FiGlobe, FiExternalLink, FiHome, FiInfo, FiBook, FiFileText, FiBarChart2, FiBriefcase, FiAward, FiDollarSign, FiGrid, FiMessageSquare, FiBookmark, FiLayers, FiUsers, FiCalendar, FiMapPin as FiLocation, FiImage, FiHelpCircle, FiWifi, FiCoffee, FiActivity, FiShield, FiTruck, FiDroplet, FiSun, FiMonitor, FiHeadphones, FiPackage, FiHeart, FiCpu, FiSettings, FiZap, FiPrinter, FiVideo, FiMusic, FiCamera, FiTarget, FiFlag, FiUmbrella, FiThermometer, FiTv, FiRadio, FiDatabase, FiServer, FiCloudRain, FiWind } from 'react-icons/fi';
import { HiOutlineAcademicCap, HiOutlineOfficeBuilding, HiOutlineCurrencyRupee, HiOutlineClipboardList, HiOutlineTrendingUp, HiOutlineUserGroup, HiOutlineLibrary, HiOutlineSparkles, HiOutlineDesktopComputer, HiOutlineBookOpen, HiOutlineBeaker } from 'react-icons/hi';
import { MdOutlineSportsBasketball, MdOutlinePool, MdOutlineFitnessCenter, MdOutlineLocalHospital, MdOutlineRestaurant, MdOutlineLocalParking, MdOutlineAtm, MdOutlineTheaters, MdOutlinePark, MdOutlineAir, MdOutlineBed, MdOutlineScience, MdOutlineComputer, MdOutlineWifi, MdOutlineLocalLaundryService, MdOutlineSecurity, MdOutlineLocalCafe, MdOutlineSportsTennis, MdOutlineSportsVolleyball, MdOutlineSportsCricket, MdOutlineSchool, MdOutlineMeetingRoom, MdOutlineEmergency, MdOutlineHealthAndSafety, MdOutlineLocalDining, MdOutlineKitchen, MdOutlineFastfood, MdOutlineApartment, MdOutlineSingleBed, MdOutlineKingBed, MdOutlineSmartDisplay, MdOutlineRouter, MdOutlineCellTower, MdOutlineEventSeat, MdOutlinePiano, MdOutlineVolunteerActivism, MdOutlineCameraOutdoor, MdOutlineGppGood, MdOutlineDirectionsBus, MdOutlineLocalTaxi, MdOutlineSolarPower, MdOutlineForest, MdOutlineLocalFlorist, MdOutlineWbSunny, MdOutlineDry } from 'react-icons/md';
