...
import { FiSearch, FiMenu, FiX, FiChevronDown, FiStar, FiMapPin, FiBookOpen } from 'react-icons/fi';
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              {user ? (
                <Link to="/dashboard">
                  <Button className="bg-orange-600 hover:bg-orange-700 hidden md:inline-flex">Dashboard</Button>
                </Link>
              ) : (
                <>
                  <Link to="/login">
      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-sm">
            <p>&copy; 2024 AdmissionBuddy. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
