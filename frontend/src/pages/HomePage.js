...
import { FiSearch, FiMenu, FiX, FiChevronDown, FiStar, FiMapPin, FiBookOpen, FiFileText, FiAward, FiTrendingUp, FiZap, FiTool, FiBriefcase, FiActivity, FiFeather, FiCpu, FiShield, FiLayout, FiBarChart2, FiCompass, FiUsers, FiBook, FiCheckCircle, FiDownload, FiArrowRight } from 'react-icons/fi';
    ...
    <div className="min-h-screen bg-white -mt-20 pt-20">
            ...
            >
              {featuredColleges.map((college, idx) => (
                <SwiperSlide key={college.id}>
                  <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition border relative">
      ...
      <section className="py-6 bg-gradient-to-r from-orange-600 to-orange-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <form className="max-w-md mx-auto flex gap-2 items-stretch">
            <Input
              type="email"
              placeholder="Enter your email"
              className="flex-1 bg-white text-gray-900 text-sm px-4 py-2.5 border-0 focus:ring-2 focus:ring-white rounded-lg"
            />
            <Button variant="secondary" className="bg-white text-orange-600 hover:bg-gray-100 px-6 py-2.5 text-sm font-semibold whitespace-nowrap rounded-lg">
              Subscribe
            </Button>
          </form>
        </div>
