...
const FallbackPrivacyPage = () => {
  const lastUpdated = 'December 19, 2025';

  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        <title>Privacy Policy | Admissionbuddy</title>
        <meta name="description" content="Learn how Admissionbuddy protects your privacy and handles your personal information." />
      </Helmet>
...
const PrivacyPolicyPage = () => {
  const { pageData, loading } = useStaticPage('privacy');
  ...
  if (hasCMSContent) {
    return (
      <StaticPageRenderer 
        ...
        fallbackContent={<FallbackPrivacyPage />}
      />
    );
  }
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="bg-gradient-to-r from-purple-700 to-indigo-800 h-48 animate-pulse" />
