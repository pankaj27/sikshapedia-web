          ...
          <div className="flex gap-6 overflow-x-auto py-4 text-sm">
            {defaultSections.map((section) => (
              <button
                ...
                className="whitespace-nowrap text-gray-600 hover:text-blue-600 font-medium transition cursor-pointer"
              >
                {section.title}
              </button>
            ))}
              ...
              <nav className="space-y-2">
                {defaultSections.map((section, idx) => (
                  <button
                    ...
                    className="flex items-center gap-2 text-sm text-gray-600 hover:text-blue-600 transition py-1 cursor-pointer w-full text-left"
                  >
