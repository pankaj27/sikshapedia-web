  ...
  const fetchAdmissions = async () => {
    try {
      ...
      const transformedData = partnersData.map(uni => ({
        ...
        programs: uni.streams || [],
        average_fees: uni.average_fees || 0,
        admission_date: uni.admission_deadline || '',
        deadline: uni.admission_deadline || '',
        students: uni.total_students || 0,
        rating: uni.rating || 0,
        description: uni.short_description || uni.description || '',
