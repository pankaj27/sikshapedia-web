...
import { FiMapPin, FiStar, FiCheckCircle, FiAward, FiDollarSign, FiFilter } from 'react-icons/fi';
    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-6 py-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Top Schools in India 2025</h1>
          <p className="text-gray-600">Explore the best schools with rankings, fees, facilities, and admission details</p>
        </div>
      </div>
              ...
              <>
                <div className="space-y-4">
                  {paginatedSchools.map((school, index) => (
                    <div key={school.id} className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow border border-gray-200">
                      <div className="p-6">
                        <div className="flex gap-6">
                          {/* School Logo */}
                          <div className="w-24 h-24 flex-shrink-0 bg-gradient-to-br from-blue-400 to-blue-600 rounded-lg overflow-hidden flex items-center justify-center">
                            {school.images?.[0] ? (
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between mb-3">
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-3 text-sm text-gray-600">
                                  ...
                                  <span className="text-blue-600 font-medium">{school.board || 'CBSE'}</span>
                                  {school.affiliation && (
                                    <>
                                      <span className="text-gray-400">|</span>
                            ...
                            <div className="grid grid-cols-4 gap-6 py-4 border-t border-b border-gray-200">
                              ...
                              <div>
                                ...
                                <div className="text-xs text-gray-500">Pass Percentage</div>
                              </div>
                              ...
                              <div>
                                ...
                                <div className="text-xs text-gray-500">Based on {school.reviews || 0} reviews</div>
                              </div>
