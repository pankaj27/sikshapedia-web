        ...
        <div className="container mx-auto px-6">
          <div className="flex items-start gap-5">
            ...
            <div className="w-16 h-16 md:w-20 md:h-20 bg-white rounded-xl shadow-lg flex items-center justify-center flex-shrink-0 overflow-hidden">
              ...
              <div className={`w-full h-full bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center ${exam.logo_url ? 'hidden' : ''}`}>
                <span className="text-white text-xl md:text-2xl font-bold">{exam.name?.charAt(0)}</span>
              </div>
            </div>
            ...
            <div className="flex-1">
              ...
              {exam.conducting_body && (
                <p className="text-blue-100 text-sm mt-1">Conducted by: {exam.conducting_body}</p>
              )}
