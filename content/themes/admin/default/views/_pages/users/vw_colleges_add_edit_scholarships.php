								...
								<div class="row">
									<div class="col-sm-12">
										<div class="row table-responsive">
											<?php $table_row='0';?>
											<table class="table" style="width:100% !important;" id="data_heading_rows">
														...
														if($value->info_value_type=='general'){
															...
															<tr id="trScholarshipsData<?php echo $table_row;?>">
															    ...
															    <div class="form-group row">
														              ...
														              <input type="number" class="form-control" name="scholarship_details[<?php echo $value->info_serial;?>][data_serial]" value="<?php echo $table_row;?>">
														              <textarea class="form-control college_general_info" rows="40" name="scholarship_details[<?php echo $table_row;?>][data_content]"><?php echo $value->info_value;?></textarea>		              
														            </div>
														        </div>
														    ...
														    <td>
															    <div class="form-group row">
																    <div class="col-md-12">
																	    <h6>Image Data</h6>
																	    <input type="hidden" id="college_general_info<?php echo $table_row;?>" name="scholarship_details[<?php echo $table_row;?>][data_type]" value="image">
																	    <input type="text" id="college_general_info<?php echo $table_row;?>" name="scholarship_details[<?php echo $table_row;?>][data_serial]" value="<?php echo $value->info_serial;?>">
																	    <input type="hidden" id="college_general_info<?php echo $table_row;?>" name="scholarship_details[<?php echo $table_row;?>][data_type_value]" value="<?php echo $value->info_value_id;?>">
																	    <input type="hidden" id="college_general_info<?php echo $table_row;?>" name="scholarship_details[<?php echo $table_row;?>][data_content]" value="<?php echo $value->info_value;?>">
																	    ...
																	    <div class="row">
																	    	<input type="text" class="form-control" name="scholarship_details[<?php echo $table_row;?>][data_type_value_alt]" placeholder="Enter SEO alternative text for the image" value="<?php echo $value->info_value_about;?>">
																	    </div>
																    <div>
															    </div>
															...
															<tr id="trScholarshipsData<?php echo $table_row;?>">
														      	<td>
																    <div class="form-group row">
																        <div class="col-md-12">
																            <h6>Content Detail</h6>
																            <input type="hidden" name="scholarship_details[<?php echo $table_row;?>][data_type]" value="ads">
																            <input type="hidden" name="scholarship_details[<?php echo $table_row;?>][data_type_value]" value="<?php echo $table_row;?>">
																            <input type="number" class="form-control" name="scholarship_details[<?php echo $table_row;?>][data_serial]" value="<?php echo $value->info_serial;?>">
																            <textarea class="form-control" rows="40" name="scholarship_details[<?php echo $table_row;?>][data_content]" style="display:none;"><?php echo $value->info_value;?></textarea>
		...
		$(document).on('click','.div_block',function(){
	      ...
	      heading_rows+='<div class="form-group row">';
	        heading_rows+='<div class="col-md-12">';
	                ...
	                heading_rows+='<input type="hidden" name="scholarship_details['+ bposthdr +'][data_type]" value="ads">';
	                heading_rows+='<input type="hidden" name="scholarship_details['+bposthdr+'][data_type_value]" value="'+datafile_id+'">';
	                heading_rows+='<input type="number" class="form-control" name="scholarship_details['+ bposthdr +'][data_serial]" value="'+ bposthdr +'">';
	                heading_rows+='<textarea class="form-control" rows="40" name="scholarship_details['+ bposthdr +'][data_content]" style="display:none;">'+d+'</textarea>';
	  	...
	  	$(document).on('click','#btn_add_heading',function(){
		    ...
		    heading_rows+='<div class="form-group row">';
		      heading_rows+='<div class="col-md-12">';
		              heading_rows+='<h6>Content Detail</h6>';
		              heading_rows+='<input type="hidden" name="scholarship_details['+ bposthdr +'][data_type]" value="general">';
		              heading_rows+='<input type="number" class="form-control" name="scholarship_details['+bposthdr+'][data_serial]" value="'+bposthdr+'">';
		              heading_rows+='<textarea class="form-control college_general_info" rows="40" name="scholarship_details['+ bposthdr +'][data_content]"></textarea>';		              
		            heading_rows+='</div>';
		        heading_rows+='</div>';
