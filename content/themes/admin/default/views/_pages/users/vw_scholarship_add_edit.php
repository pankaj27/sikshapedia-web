							...
							<div class="row">
								<div  class="row table-responsive" id="heading_rows">
									<table class="table">
										...
										<?php
										if(!empty($college_scholarship_data)){
											foreach ($college_scholarship_data as $key => $value) {
