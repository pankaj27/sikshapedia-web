...
<div class="page-content">
	<nav class="page-breadcrumb">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="<?php echo $admin_base_url;?>/institutions/colleges">Institutes</a></li>
			<li class="breadcrumb-item active" aria-current="page"><?php echo (!empty($college_id))?'Update':'Add';?> Institute</li>
		</ol>
	</nav>
	...
	<div class="row">
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h6 class="card-title"><?php echo (!empty($college_id))?'Update':'Add';?> Institute - [ <?php echo (!empty($college_data))?$college_data['college_name']:'';?> ]  <button type="button" class="btn btn-xs btn-info" data-target="#notesModal" data-toggle="modal">Note</button></h6>
					...
					<div style="border: 2px solid #e0f6f6;border-radius: 10px;padding: 20px;margin-bottom: 20px;">
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<select class="form-control" name="college_utype" id="college_utype">
										...
										<option value="5" <?php echo (!empty($college_data) && ($college_data['college_utype']=='5'))?'selected':'';?>>School</option>
										<option value="6" <?php echo (!empty($college_data) && ($college_data['college_utype']=='6'))?'selected':'';?>>Study Center</option>
									</select>
								</div>
							</div>							
						</div>
						...
						<div class="row">
							<div class="col-sm-4">
								<div class="form-group">
									<label class="control-label">Institute Short Name</label>
							...
							<div class="col-sm-4">
								<div class="form-group">
									<label class="control-label">Institute Phone No.</label>
						...
						<div class="row">
							<div class="col-sm-4">
								<div class="form-group">
									<label class="control-label">Institute Other Phone No.</label>
									<input type="text" class="form-control" placeholder="Enter official other phone no." name="college_other_phone" id="college_other_phone" value="<?php echo (!empty($college_data))?$college_data['college_alter_phone_no']:'';?>">
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form-group">
									<label class="control-label">Institute Whatsapp No.</label>
									<input type="text" class="form-control" placeholder="Enter official Whatsapp no." name="college_whatsapp_no" id="college_whatsapp_no" value="<?php echo (!empty($college_data))?$college_data['college_whatsapp_no']:'';?>">
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form-group">
									<label class="control-label">Institute Web Address</label>
									<input type="text" class="form-control" placeholder="Institute Web Address" name="college_web_address" id="college_web_address" value="<?php echo (!empty($college_data))?$college_data['college_web_address']:'';?>">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-2">
								<div class="form-group">
									<label class="control-label">Institute Estd. In</label>
						...
						<div class="row">							
							<div class="col-sm-8">
								<div class="form-group">
									...
									<textarea class="form-control" rows="2" placeholder="Institute Address" name="college_address"><?php echo (!empty($college_data))?$college_data['college_address']:'';?></textarea>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form-group">
									<label class="control-label">Pincode</label>
									<input type="text" class="form-control" placeholder="Institute pincode" name="college_pincode" value="<?php echo (!empty($college_data))?$college_data['college_pincode']:'';?>">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<?php
								if(!empty($college_data) && !empty($college_data['college_google_map'])){
									?>
									<iframe data-src="<?php echo $college_data['college_google_map'];?>" src="<?php echo $college_data['college_google_map'];?>" class="lazyloaded" width="100%"></iframe>
									<?php
								}
								?>								
							</div>
						...
						<div style="border: 2px solid #e0f6f6;border-radius: 10px;padding: 20px;margin-bottom: 20px;">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label>Institute Logo File SEO Name</label>
										<div class="input-group col-xs-12">
											<input type="text" class="form-control file-upload-info" placeholder="Seo Friendly File Name" name="college_logo_seo_file_name" value="<?php echo (!empty($college_data))?str_replace('sikshapedia logo','',strtolower($college_data['college_logo_file_seo_name'])):'';?>">
										</div>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label>Institute Banner File SEO Name</label>
										<div class="input-group col-xs-12">
											<input type="text" class="form-control file-upload-info" placeholder="Seo Friendly File Name" name="college_banner_seo_file_name" value="<?php echo (!empty($college_data))?str_replace('sikshapedia banner','',strtolower($college_data['college_banner_file_seo_name'])):'';?>">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label>Institute Logo Alt Name</label>
										<div class="input-group col-xs-12">
											<input type="text" class="form-control file-upload-info" placeholder="Seo Friendly Alt Name" name="college_logo_seo_alt_name" value="<?php echo (!empty($college_data))?$college_data['college_logo_alt_text']:'';?>">
										</div>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label>Institute Banner Alt Name</label>
										<div class="input-group col-xs-12">
											<input type="text" class="form-control file-upload-info" placeholder="Seo Friendly File Name" name="college_banner_seo_alt_name" value="<?php echo (!empty($college_data))?$college_data['college_banner_alt_text']:'';?>">
										</div>
									</div>
								</div>
							</div>
						...
						<div style="border: 2px solid #e0f6f6;border-radius: 10px;padding: 20px;margin-bottom: 20px;">
							...
							<div class="row">
								...
								//if($userdata->user_role=='1'){
									...
									<div class="col-sm-3">
										<div class="form-group">
											<label class="control-label">Is Featured Institute</label>
											<select class="form-control" name="college_is_featured">											
												<option value="2" <?php echo (!empty($college_data) && isset($college_data['college_is_featured']) && ($college_data['college_is_featured']=='2'))?'selected':'';?>>No</option>
												<option value="1" <?php echo (!empty($college_data) && isset($college_data['college_is_featured']) && ($college_data['college_is_featured']=='1'))?'selected':'';?>>Yes</option>
											</select>
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											...
											<select class="form-control" name="college_is_visible_in_home_page">
												<option value="1" <?php echo (!empty($college_data) && isset($college_data['college_show_in_home_page']) && ($college_data['college_show_in_home_page']=='1'))?'selected':'';?>>Yes</option>
												<option value="2" <?php echo (!empty($college_data) && isset($college_data['college_show_in_home_page']) && ($college_data['college_show_in_home_page']=='2'))?'selected':'';?>>No</option>
											</select>
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label class="control-label">Assigned Verified Badge</label>
											<select class="form-control" name="college_has_verified_badge">		
												<option value="no" <?php echo (!empty($college_data) && isset($college_data['college_has_verified_badge']) && ($college_data['college_has_verified_badge']=='no'))?'selected':'';?>>No</option>
												<option value="yes" <?php echo (!empty($college_data) && isset($college_data['college_has_verified_badge']) && ($college_data['college_has_verified_badge']=='yes'))?'selected':'';?>>Yes</option>
											</select>
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label class="control-label">Has Leads Access</label>
											<select class="form-control" name="college_has_leads_access" id="college_has_leads_access">		
												<option value="no" <?php echo (!empty($college_data) && isset($college_data['college_has_leads_access']) && ($college_data['college_has_leads_access']=='no'))?'selected':'';?>>No</option>
												<option value="yes" <?php echo (!empty($college_data) && isset($college_data['college_has_leads_access']) && ($college_data['college_has_leads_access']=='yes'))?'selected':'';?>>Yes</option>
											</select>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<label class="control-label">Leads Area (District)</label>
											<select class="form-control" name="college_has_leads_area_dist[]" id="college_has_leads_area_dist" <?php echo (!empty($college_data) && ($college_data['college_has_leads_access']=='no'))?'disabled':'';?> multiple>	
												<option value="0">Select dictrict</option>	
												<?php
												if(!empty($leads_districts)){
													foreach ($leads_districts as $key => $value) {
														?>
														<option value="<?php echo $value->district_id;?>" <?php echo in_array($value->district_id, $college_data['college_leads_district'])?'selected':'';?>><?php echo $value->district_name;?></option>
														<?php
													}
												}
												?>
									...
									<div class="col-sm-6">
										<div class="form-group">
											<label class="control-label">Leads Type</label>
											<select class="form-control" name="college_leads_type[]" multiple id="college_leads_type" <?php echo (!empty($college_data) && ($college_data['college_has_leads_access']=='no'))?'disabled':'';?>>		
												<option value="1" <?php echo (!empty($college_data) && (in_array(1, $college_data['college_leads_type'])))?'selected':'';?>>Nursing</option>
												<option value="2" <?php echo (!empty($college_data) && (in_array(2, $college_data['college_leads_type'])))?'selected':'';?>>Pharmacy</option>
												<option value="3" <?php echo (!empty($college_data) && (in_array(3, $college_data['college_leads_type'])))?'selected':'';?>>Engineering</option>
												<option value="4" <?php echo (!empty($college_data) && (in_array(4, $college_data['college_leads_type'])))?'selected':'';?>>Paramedical</option>
												<option value="5" <?php echo (!empty($college_data) && (in_array(5, $college_data['college_leads_type'])))?'selected':'';?>>Management</option>
											</select>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<label class="control-label">Leads Type Course</label>
											<select class="form-select" name="college_leads_coursee[]" multiple id="college_leads_coursee" aria-invalid="true">
												<?php
												if(!empty($college_data) && $college_data['college_leads_courses']){
													foreach ($college_data['college_leads_courses'] as $key => $value) {
														?>
									...
									<div class="col-sm-3">
										<div class="form-group">
											<label>Leads Gender</label>
											<div class="input-group col-xs-12">
												<select class="form-select" name="college_leads_gender" id="college_leads_gender" aria-invalid="true">
													<option value="na" <?php echo (!empty($college_data) && ($college_data['college_leads_gender']=='na'))?'selected':'';?>>Not Applicable</option>
													<option value="male" <?php echo (!empty($college_data) && ($college_data['college_leads_gender']=='male'))?'selected':'';?>>Male</option>
													<option value="female" <?php echo (!empty($college_data) && ($college_data['college_leads_gender']=='female'))?'selected':'';?>>Female</option>
												</select>
											</select>
											</div>
										</div>
									...
									<div class="col-sm-3">
										<div class="form-group">
											...
											<div class="input-group col-xs-12">
												<input type="text" class="form-control file-upload-info" placeholder="Leads Per Day" name="college_leads_per_day" id="college_leads_per_day" value="<?php echo (!empty($college_data))?$college_data['college_perday_leads']:'';?>" <?php echo (!empty($college_data) && ($college_data['college_has_leads_access']=='no'))?'disabled':'';?>>
											</div>
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											...
											<div class="input-group col-xs-12">
												<input type="text" class="form-control file-upload-info" placeholder="Leads Per Day" id="college_max_leads" name="college_max_leads" value="<?php echo (!empty($college_data))?$college_data['college_max_leads']:'';?>" <?php echo (!empty($college_data) && ($college_data['college_has_leads_access']=='no'))?'disabled':'';?>>
											</div>
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											...
											<div class="input-group col-xs-12">
												<input type="text" class="form-control file-upload-info" placeholder="Leads Start Date" name="college_leads_start_date" id="college_leads_start_date" value="<?php echo (!empty($college_data))?$college_data['college_leads_start']:'';?>"  <?php echo (!empty($college_data) && ($college_data['college_has_leads_access']=='no'))?'disabled':'';?>>
											</div>
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											...
											<div class="input-group col-xs-12">
												<input type="text" class="form-control file-upload-info" placeholder="Leads End Date" name="college_leads_end_date" id="college_leads_end_date" value="<?php echo (!empty($college_data))?$college_data['college_leads_end']:'';?>" <?php echo (!empty($college_data) && ($college_data['college_has_leads_access']=='no'))?'disabled':'';?>>
											</div>
										</div>
									</div>
									<?php
						...
						<div class="row">
							<div class="col-md-12">
								<div class="table-responsive">
									<table class="table" id="ytr_table">
										<thead>
											<th>Video</th>
											<th><button class="btn btn-sm btn-primary" type="button" id="btn_add_yt_video"><i class="fa fa-plus"></i></button></th>
										</thead>
										<tbody>
											<?php
											if(!empty($college_data['college_intro_video'])){
												foreach ($college_data['college_intro_video'] as $key => $value) {
													?>
													<tr id="ytr<?php echo $yt;?>">
														<td width="90%">
															<div class="row">
																<div class="col-sm-12">
																	<input type="text" class="form-control" placeholder="Intro Video" name="ytvideo[<?php echo $yt;?>][link]" value="<?php echo $value->media_disk_path_relative;?>" onpaste="onPaseteYTVid('<?php echo $yt;?>')">
																</div>
																<div class="col-sm-12" id="ytrdiv<?php echo $yt;?>">
																	<div class="embed-responsive embed-responsive-16by9">
																	  <iframe id="ytrframe<?php echo $yt;?>" width="200" height="200" src="<?php echo $value->media_disk_path_relative;?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
																	</div>
																</div>
															</div>
														</td>
														<td width="10%">
															<button class="btn btn-sm btn-danger" type="button" onclick="$('#ytr<?php echo $yt;?>').remove()"><i class="fa fa-trash"></i></button>
														</td>
													</tr>
													<?php
													$yt++;
												...
												<tr id="ytr<?php echo $yt;?>">
													<td width="90%">
														<div class="row">
															<div class="col-sm-12">
																<input type="text" class="form-control" placeholder="Intro Video" name="ytvideo[<?php echo $yt;?>][link]" value="" onpaste="onPaseteYTVid('<?php echo $yt;?>')">
															</div>
															<div class="col-sm-12" id="ytrdiv<?php echo $yt;?>" style="display: none;">
																<div class="embed-responsive embed-responsive-16by9">
																  <iframe id="ytrframe<?php echo $yt;?>" width="200" height="200" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
																</div>
															</div>
														</div>
													</td>
						...
						<script type="text/javascript">var ytrow='<?php echo $yt;?>';</script>

						<div class="row">
							<div class="col-sm-3">
								<div class="form-group">
									<label class="control-label">Institute Grades</label>
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<textarea class="form-control" name="college_info_menu_page_heading" rows="5">
										<?php echo (!empty($college_data) && isset($college_data['college_info_page_heading']))?$college_data['college_info_page_heading']:'';?>
									</textarea>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									<label><strong>Other Institutes In The Same Group</strong></label>
						...
						<div class="row">
							<div class="col-sm-12">
								<label><strong>Institute Ranking Description</strong></label>
		        						...
		        						if(!empty($college_ranking_data)){
		        							...
		        							foreach ($college_ranking_data as $k => $v) {
			        							...
			        							<tr id="tr<?php echo $cri;?>">
				        							...
				        							<td>
				        								<select class="form-control" name="college_ranking[<?php echo $cri;?>][state]">
				        									<option value="0">Select State</option>
															<?php
															if(!empty($states)){
																foreach ($states as $key => $value) {
																	if(!empty($v->ranking_state_id)){
																		?>
																		<option value="<?php echo $value['state_id'];?>" <?php echo (decode_data($value['state_id'])==$v->ranking_state_id)?'selected':'';?>><?php echo $value['state_name'];?></option>
																		<?php
																	}else{
																		?>
																		<option value="<?php echo $value['state_id'];?>" <?php echo (decode_data($value['state_id'])==$college_data['college_state'])?'selected':'';?>><?php echo $value['state_name'];?></option>
																		<?php
																	}
																	?>
				        							...
				        							<td>
				        								<input class="form-control" name="college_ranking[<?php echo $cri;?>][state_value]" value="<?php echo $v->ranking_state_value;?>">
				        							</td>
				        							<td>
				        							...
				        							<td><button type="button" class="btn btn-xs btn-danger btn_dele_rank" data-rank_id="<?php echo $v->inst_rank_id;?>" data-college_id="<?php echo decode_data($college_id);?>" data-rank_row="<?php echo $cri;?>"><i class="fa fa-minus"></i></button></td>
				        						</tr>
			        							<?php
								...
								<div class="form-group" id="college_affiliations_div">
									<?php
										if(!empty($institute_affiliations)){
											...
											<label class="control-label"><strong>Institute Affiliation</strong></label><br>
											<?php
						...
						<h6>Institute Introduction (Short Description)</h6>
						<hr>
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
						...
						<h6>Institute Introduction (Broad Description)</h6>
						<hr>
						...
						<!-- <div class="row" style="padding: 10px;">
							<div class="col-sm-6">
								<h6>Institute More Descriptions & Medias</h6>
							</div>

							<div class="col-sm-6">
								<button class="btn btn-sm btn-primary" type="button" id="btn_add_description">Add Description</button>
								<button class="btn btn-sm btn-primary" type="button" id="btn_add_video">Add Video</button>
								<button class="btn btn-sm btn-primary" type="button" id="btn_add_image">Add Image</button>
							</div>

						</div>

						<div class="row" id="more description_row">
							<?php $mr=0;?>
							<div class="col-sm-12">
								<div class="form-group">									
									<textarea class="form-control college_info" name="college_more_info[<>php echo $i;?>][description]" id="college_more_info_0" rows="10" >
	    			...
	    			<div class="col-md-12">
	    				<div class="mb-7" id="quality-guidelines" wfd-id="54">
	    					...
	    					<ol class="text-h6 pb-1" type="1">
	    						<li class="mb-2"><b>Institute Name</b>-Name Should not contain anyspace before and after and any special charachter(*,+,/,@,#,$,%,^,& etc) and numeric values</li>
	    						<li class="mb-2"><b>Institute Email</b> - Valid email.</li>
	    						<li class="mb-2"><b>Institute Pho No.</b> - Valid phone no.(not like these 1111111111111/22222222222/00000000 and so on)</li>
	    						<li class="mb-2"><b>Institute Estd. Year</b></li>
	    						<li class="mb-2"><b>Institute Logo & Banner</b> - you can have that from google</li>
	    						<li class="mb-2"><b>Institute Address & Pincode</b></li>
	    						<li class="mb-2"><b>Institute Type</b> - Select from the list.</li>
	    						<li class="mb-2"><b>Institute Country</b> - Select from the list.</li>
	    						<li class="mb-2"><b>Institute State</b> - Select from the list.</li>
	    						<li class="mb-2"><b>Institute District</b> - Select from the list if available.</li>
	    						<li class="mb-2"><b>Institute City</b> - Select from the list.</li>
	    						<li class="mb-2"><b>Institute University</b> - Select from the list.</li>
	    						<li class="mb-2"><b>Institute Intro Video</b> - Youtube link(If available).</li>
	    						<li class="mb-2"><b>Institute Country</b> - Select from the list.</li>
	    						<li class="mb-2"><b>Institute Affiliations</b> - Select from the list.</li>
	    						<li class="mb-2"><b>Institute Faciloities</b> - Select from the list(If available).</li>
	    						<li class="mb-2"><b>Institute Facilities Intro</b> - If Available.</li>
	    						<li class="mb-2"><b>Institute Short Description</b> - You can have from the google or collegedunia.com.</li>
	    						<li class="mb-2"><b>Institute Broad Description</b> - You can have from the google or collegedunia.com.</li>
	    						<li class="mb-2"><b>Institute Faqs</b> - You can have from the google or collegedunia.com.</li>
	    						<li class="mb-2"><b>Institute Placement Description & Faqs</b> - You can have from the google or collegedunia.com.</li>
	    						<li class="mb-2"><b>Institute Scholarship Faqs</b> - You can have from the google or collegedunia.com.</li>
	    						<li class="mb-2"><b>Institute Hostel Info</b> - You can have from the google or collegedunia.com.</li>

	    						<li class="mb-2"><b>Institute Courses Info</b> - You can have from the collegedunia.com.</li>
	    						<li class="mb-2"><b>Institute Cutoffs Info</b> - You can have from the google or collegedunia.com.</li>
	    						<li class="mb-2"><b>Institute Admission Info</b> - You can have from the collegedunia.com.</li>
	    						<li class="mb-2"><b>Institute Placement detailed Info</b> - You can have from the collegedunia.com. (If not available leave that blank)</li>
	    						<li class="mb-2"><b>Institute Placement Companies Info</b> - You can have from the collegedunia.com. and companies list available in WaytoAdmissions</li>
	    						<li class="mb-2"><b>Institute Scholarship Detailed Info</b> - You can have from the collegedunia.com. (If not available leave that blank)</li>
	    						<li class="mb-2"><b>Institute Institute Gallery & Videos</b> - You can have from the collegedunia.com. (If not available leave that blank)</li>
...
<script type="text/javascript">
	...
	foreach ($institute_ranking_bodies as $key => $value) {
		...
		var rank_id_<?php echo decode_data($value['rank_body_id']);?>=<?php echo $value['rank_value'];?>;
...
var uniqueID = 1; // Generate a unique ID

// $(document).ready({
// 	$('body').on('click','#btn_add_description',function(){
// 		var html='<div class="col-sm-12">';
//                 html='<div class="form-group">';
//                     html='<textarea class="form-control college_info" name="college_more_info['+uniqueID+'][description]" id="college_more_info_'+uniqueID+'" rows="10"></textarea>';
//                 html='</div>';
//             html='</div>';
//             html='<div class="col-sm-12">';
//                 html='<button class="btn btn-sm btn-danger" type="button" onclick="$(\'#college_more_info_' + uniqueID + '\').parent().parent().remove()">Remove</button>';
//             html='</div>';

//          // Append the HTML to the 'more_description_row' element
//         $('#more_description_row').append(html);
