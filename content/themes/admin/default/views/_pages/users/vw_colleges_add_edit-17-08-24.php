				...
				<div class="card-body">
					...
					<div style="border: 2px solid #e0f6f6;border-radius: 10px;padding: 20px;margin-bottom: 20px;">
						...
						<div class="row">
							<div class="col-sm-4">
								<div class="form-group">
									<label class="control-label">College Other Phone No.</label>
							...
							<div class="col-sm-4">
								<div class="form-group">
									<label class="control-label">College Whatsapp No.</label>
							...
							<div class="col-sm-4">
								<div class="form-group">
									<label class="control-label">College Web Address</label>
									<input type="text" class="form-control" placeholder="College Web Address" name="college_web_address" id="college_web_address" value="<?php echo (!empty($college_data))?$college_data['college_web_address']:'';?>">
								</div>
							</div>
						</div>
						<div class="row">
						...
						<div style="border: 2px solid #e0f6f6;border-radius: 10px;padding: 20px;margin-bottom: 20px;">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label>College Logo File SEO Name</label>
										<div class="input-group col-xs-12">
								...
								<div class="col-sm-6">
									<div class="form-group">
										<label>College Banner File SEO Name</label>
										<div class="input-group col-xs-12">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label>College Logo Alt Name</label>
										<div class="input-group col-xs-12">
								...
								<div class="col-sm-6">
									<div class="form-group">
										<label>College Banner Alt Name</label>
										<div class="input-group col-xs-12">
									...
									<div class="col-sm-3">
										<div class="form-group">
											...
											<select class="form-control" name="college_has_verified_badge">		
												<option value="no" <?php echo (!empty($college_data) && ($college_data['college_has_verified_badge']=='no'))?'selected':'';?>>No</option>
												<option value="yes" <?php echo (!empty($college_data) && ($college_data['college_has_verified_badge']=='yes'))?'selected':'';?>>Yes</option>
											</select>
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											...
											<select class="form-control" name="college_has_leads_access" id="college_has_leads_access">		
												<option value="no" <?php echo (!empty($college_data) && ($college_data['college_has_leads_access']=='no'))?'selected':'';?>>No</option>
												<option value="yes" <?php echo (!empty($college_data) && ($college_data['college_has_leads_access']=='yes'))?'selected':'';?>>Yes</option>
											</select>
										</div>
									</div>
									<div class="col-sm-3">
						...
						<!-- <div class="row" style="padding: 10px;">
							<div class="col-sm-6">
								<h6>College More Descriptions & Medias</h6>
							</div>
