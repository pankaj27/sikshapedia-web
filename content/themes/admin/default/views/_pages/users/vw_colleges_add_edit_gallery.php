...
<div class="page-content">
	<nav class="page-breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">College Gallery Data</li>
		</ol>
	</nav>
		...
		<div class="profile-page tx-13">
				...
				<div class="col-12 grid-margin">
					<div class="profile-header">
						<div class="cover">
							...
							<figure>
								<img src="<?php echo (!empty($college_data))?$college_data['college_banner']:'';?>" class="img-fluid" alt="profile cover" style="height: 250px;">
							</figure>
			...
			<div class="row">
				<div class="col-md-12 grid-margin">
					<div class="card">
						<div class="card-body">
							<h6 class="card-title"><?php echo (!empty($college_data['college_faculties']))?'Update':'Add';?> College - [ <?php echo (!empty($college_data))?$college_data['college_name']:'';?> ]-[ Gallery Data ]</h6>
							<form id="form_gallery">
			            		<input type="hidden" name="<?php echo $csrf['name'];?>" value="<?php echo $csrf['hash'];?>">
			            		<input type="hidden" class="form-control" name="_gallery" value="">
		            			...
		            			<div class="row">
									...
									<div class="col-sm-6" id="college_gallery_image_div">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="Image Alt Title" name="college_gallery_image_alt" id="college_gallery_image_alt" value="">
										</div>
										<div class="form-group">
											<label>Image Caption</label>
											<input type="text" class="form-control" placeholder="Image Caption" name="college_gallery_image_caption" id="college_gallery_image_caption" value="">
										</div>
									</div>
								...
								<div class="row">
									<div class="col-sm-12">
										<button class="btn btn-primary" type="submit" id="btn_save_form_gallery">Save</button>
									</div>
								</div>
			            	</form>
						</div>
			...
			<div class="row">
				<div class="col-md-12 grid-margin">
					<div class="card">
						<div class="card-body">
							<h6 class="card-title">Galleries</h6>
...
<script type="text/javascript">let _college='<?php echo (!empty($college_data))?$college_data['college_id']:'';?>';var colleg_faq_row='';var _ur='';var colleg_placement_faq_row='';var colleg_ranking_row='';var p_row='';var colleg_scholarship_faq_row='';var college_type='101';</script>