...
<div class="page-content">
	<nav class="page-breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">System Student User's List</li>
		</ol>
	</nav>
	...
	<div class="row">
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h6 class="card-title">Student Users</h6>
					<div class="col-md-12">
						<div class="table-responsive">
							...
							<table id="college_user_student_list_table" class="table">
								<thead>
			                      <tr>
			                        <th>#</th>
			                        <th>Code</th>
...
<script type="text/javascript">var _user_type='';</script>