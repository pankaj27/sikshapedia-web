...
<div class="page-content">
	...
	<div class="row">
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h6 class="card-title">News <a href="<?php echo $admin_base_url;?>/news/add" class="btn btn-sm btn-primary pull-right" style="float:right;">Add</a></h6>
					<div class="col-md-12">
...
<script type="text/javascript">var news_type='all';var news_types_id='';var parent_folder='';</script>