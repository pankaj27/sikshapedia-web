...
<div class="page-content">
	...
	<div class="row">
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h6 class="card-title">All Contacts

						<button type="button" id="btn_add_contact" class="btn btn-primary" data-target="#contactModal" data-toggle="modal" style="float:right;">Create Contact</button>
					</h6>
					<div class="table-responsive">
						<table id="campaign_contact_list_table" class="table">
							<thead>
		                      <tr>
		                        <th>#</th>
		                        <th>Name</th>
