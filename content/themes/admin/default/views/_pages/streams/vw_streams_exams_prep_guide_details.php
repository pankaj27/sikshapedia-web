		...
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					...
					<div class="col-md-12">
						<form id="form_exams_prep_details_data_add_edit" method="post" enctype="multipart/form-data">
							<input type="hidden" name="<?php echo $csrf['name'];?>" value="<?php echo $csrf['hash'];?>">
							<input type="hidden" name="_exam" id="_exam" value="<?php echo $exam_id;?>">
							<input type="hidden" name="_prep_id" id="_prep_id" value="<?php echo $prep_id;?>">
											...
											if(!empty($prep_details)){
												...
												foreach ($prep_details as $key => $value) {
													if($value->exam_data_type=='general'){
														?>
														<tr id="trExamPrepDetails<?php echo $table_row;?>">
															<td>
																<div class="form-group row">
																	<div class="col-md-12">
														            	<label for="system_meta_title"><strong>Preparation Guide Detail</strong></label>
														            	<input type="hidden" name="prep_details[<?php echo $table_row;?>][data_type]" value="general">

														            	<input type="hidden" class="form-control" name="prep_details[<?php echo $table_row;?>][data_serial]" value="<?php echo $value->exam_serial;?>">

														            	<textarea class="form-control prep_details" rows="40" name="prep_details[<?php echo $table_row;?>][exam_content]"><?php echo $value->exam_content;?></textarea>
														          	</div>
														        </div>
														        ...
														        if($table_row>0){
														        	...
														        	<div class="form-group row"><div class="col-md-12">
															        	<button type="button" class="btn btn-danger btn-icon-text mb-2 mb-md-0 pull-right" onclick="$('#trExamPrepDetails<?php echo $table_row;?>').remove()">Delete Row</button>
															        </div>
														        	<?php
														        }
														        ?>
													...
													<td>
														<div class="form-group row">
															<div class="col-md-12">
												            	<label for="system_meta_title"><strong>Preparation Guide Detail</strong></label>
												            	<input type="hidden" name="prep_details[<?php echo $table_row;?>][data_type]" value="general">
												            	<input type="hidden" class="form-control" name="prep_details[<?php echo $table_row;?>][data_serial]" value="1">
												            	<textarea class="form-control prep_details" rows="40" name="prep_details[<?php echo $table_row;?>][prep_content]"></textarea>
												          	</div>
												        </div>
													</td>
												</tr>
							...
							<div class="row">
	        					...
	        					<div class="col-sm-12">
	        						<table class="table" id="form_exam_prep_faqus_table">
			        					<thead>
			        						<tr>
			        					...
			        					<?php
			        					$exf=0;
			        					if(!empty($exam_prep_faq_details)){
			        						foreach ($exam_prep_faq_details as $key => $value) {
			        							?>
			        							<tr>
				        							<td>
				        								<div class="row">
					        								<input type="text" class="form-control" name="exam_prep_faqus[<?php echo $exf;?>][ques]" aria-describedby="college_faqus" placeholder="Question" value="<?php echo $value->exam_content_faq;?>">
					        							</div>

					        							<div class="row">
					        								<textarea class="form-control exam_prep_info" name="exam_prep_faqus[<?php echo $exf;?>][ans]" placeholder="Answer" rows="5" style="width:100%;">
			        						...
			        						<tr>
			        							<td>
			        								<div class="row">
				        								<input type="text" class="form-control" name="exam_prep_faqus[<?php echo $exf;?>][ques]" aria-describedby="college_faqus" placeholder="Question" value="">
				        							</div>

				        							<div class="row">
				        								<textarea class="form-control exam_prep_info" name="exam_prep_faqus[<?php echo $exf;?>][ans]" placeholder="Answer" rows="5" style="width:100%;"></textarea>
				        							</div>
				        						</td>

				        						<td><button type="button" class="btn btn-xs btn-primary" id="btn_add_exam_prep_faqus_row"><i class="fa fa-plus"></i></button></td>
				        					</tr>
			        						<?php
			        					}
			        					?>      							
			        				...
			        				<script type="text/javascript">var exam_prep_faq_row='<?php echo $exf;?>';</script>
	        					</div>
	        				</div>
							...
							<div class="row">
								<div class="buy-now-wrapper" id="buttons_wrapper">
									...
									<button type="submit" class="btn btn-success btn-icon-text mb-2 mb-md-0" id="btn_save_exam_prep_details">Save Data</button>
								</div>
							</div>
						</form>
					</div>
...
<div class="modal fade bd-example-modal-xl" id="fileUploadModal" tabindex="-1" role="dialog" aria-labelledby="fileUploadModal" aria-hidden="true">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="file_upload_type" id="file_upload_type">
									...
									<option value="preparation_guide_files">Preparation Guide</option>
...
<script type="text/javascript">var phdr='<?php echo ($table_row==0)?($table_row+1):$table_row;?>';</script>
...
<script type="text/javascript">
	...
	var exam_prep_id='<?php echo $prep_id;?>';
	var p_row='';
</script>