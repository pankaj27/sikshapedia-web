...
<div class="page-content">
	...
	<div class="row">
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h6 class="card-title">Ads <a href="<?php echo $admin_base_url;?>/ads/add" class="btn btn-sm btn-primary pull-right" style="float:right;">Create Ads</a><a href="<?php echo $admin_base_url;?>/adsgroup/add" class="btn btn-sm btn-primary pull-right" style="float:right;">Create Group Ads</a></h6>
					<div class="col-md-12">
