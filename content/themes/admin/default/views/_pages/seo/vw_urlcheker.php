...
<div class="page-content">
	<nav class="page-breadcrumb">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="<?php echo $admin_base_url;?>/streams">URL Checker</a></li>
			<li class="breadcrumb-item active" aria-current="page">URL's List</li>
		</ol>
	</nav>
	...
	<div class="row">
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h6 class="card-title">URL's</h6>
					<div class="table-responsive">
						<table id="seo_url_list_table" class="table">
							<thead>
		                      <tr>
		                        <th>#</th>
		                        <th>URL</th>
...
<div class="modal fade bd-example-modal-xl modal-fullscreen" id="editURLMeta" tabindex="-1" role="dialog" aria-labelledby="editURLMetaLabel" aria-hidden="true" style="z-index:99999;">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editURLMetaTitle">Edit URL Meta</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
