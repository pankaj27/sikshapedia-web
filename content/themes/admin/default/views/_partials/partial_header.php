...
<nav class="navbar">
	...
	<div class="navbar-content">
		...
		<ul class="navbar-nav">
				...
				<div class="dropdown-menu" aria-labelledby="appsDropdown">
					...
					<div class="dropdown-body">
						<div class="d-flex align-items-center apps">
							...
							<a href="<?php echo $admin_base_url;?>/profile"><i data-feather="instagram" class="icon-lg"></i><p>Profile</p></a>
						</div>
					</div>
			...
			<li class="nav-item"><button type="button" class="btn btn-primary btn-sm" data-target="#editorVersionModal" data-toggle="modal">Change Editor Version</button></li>
				...
				<div class="dropdown-menu" aria-labelledby="profileDropdown">
					<div class="dropdown-header d-flex flex-column align-items-center">
						...
						<div class="info text-center">
							<p class="name font-weight-bold mb-0"><?php echo $userdata->user_fullname;?></p>
							<p class="email text-muted mb-3"><?php echo $userdata->user_email;?></p>
						</div>
					</div>
					<div class="dropdown-body">
						<ul class="profile-nav p-0 pt-3">
							<li class="nav-item">
								<a href="<?php echo $admin_base_url;?>/profile" class="nav-link">
									<i data-feather="user"></i>
									<span>My Profile</span>
								</a>
							</li>
							<li class="nav-item">
								<a href="#" data-toggle="modal" data-target="#changePassModal" class="nav-link">
									<i data-feather="lock"></i>
									<span>Change Password</span>
								</a>
							</li>
							<li class="nav-item">
								<a href="<?php echo $admin_base_url.'/logout';?>" class="nav-link">
