<div class="modal fade bd-example-modal-xl" id="menuWidgetAddModal" tabindex="-1" role="dialog" aria-labelledby="menuWidgetAddModal" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="menuWidgetAddModalTitle"></h5>
