jQuery(function($) {
     ...
     $(document).on('click','.div_block',function(){
      ...
      heading_rows+='<div class="form-group row">';
        heading_rows+='<div class="col-md-12">';
                ...
                heading_rows+='<input type="hidden" name="admission_details['+ hdr +'][data_type]" value="ads">';
                heading_rows+='<input type="hidden" name="admission_details['+hdr+'][data_type_value]" value="'+datafile_id+'">';
                heading_rows+='<textarea class="form-control" rows="40" name="admission_details['+ hdr +'][admission_content]" style="display:none;">'+d+'</textarea>';
  ...
  $('.file-upload-default').on('change', function() {
    ...
    $(document).on('click','#btn_add_admission_faqus_row',function(){
      ...
      html+='<textarea class="form-control admission_details" name="admission_faqus['+afr+'][ans]" aria-describedby="admission_faqus" placeholder="Answer" rows="5"></textarea>';
      html+='</td>';
      html+='<td>';
      html+='<div class="btn-group">';
      html+='<button type="button" class="btn btn-xs btn-primary" id="btn_add_admission_faqus_row"><i class="fa fa-plus"></i></button>';
