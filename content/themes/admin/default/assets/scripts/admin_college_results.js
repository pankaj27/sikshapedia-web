jQuery(function($) {
  ...
  function add_other_info(){
    ...
    formData.append('college_details_type', 'result_details');
    ...
    heading_rows+='<td>';
      heading_rows+='<div class="form-group row">';
        heading_rows+='<div class="col-md-12">';
                ...
                heading_rows+='<textarea class="form-control result_details" rows="40" name="result_details['+ hdr +'][result_content]"></textarea>';
              heading_rows+='</div>';
          heading_rows+='</div>';
   ...
   $('#tinyFileBrowserModal').on('shown.bs.modal', function (e) {
    ...
    $(document).on('click','.img-fluid',function(){
      ...
      var heading_rows='';
        ...
        heading_rows+='<input type="hidden" name="result_details['+hdr+'][data_type]" value="image">';
        heading_rows+='<input type="hidden" name="result_details['+hdr+'][data_type_value]" value="'+datafile_id+'">';
        heading_rows+='<input type="hidden" name="result_details['+hdr+'][result_content]" value="'+dataimg+'">';
     ...
     $(document).on('click','.div_block',function(){
      ...
      heading_rows+='<div class="form-group row">';
        heading_rows+='<div class="col-md-12">';
                ...
                heading_rows+='<input type="hidden" name="result_details['+hdr+'][data_type_value]" value="'+datafile_id+'">';
                heading_rows+='<textarea class="form-control" rows="40" name="result_details['+ hdr +'][result_content]" style="display:none;">'+d+'</textarea>';
  ...
  $('.file-upload-default').on('change', function() {
    ...
    $(document).on('click','#btn_add_result_faqus_row',function(){
      var html='';

      html+='<tr id="tr' + afr + '">';
      html+='<td>';
      html+='<textarea class="form-control" name="result_faqus['+afr+'][ques]" aria-describedby="result_faqus" placeholder="Question" rows="5"></textarea>';
      html+='</td>';
      html+='<td>';
      html+='<textarea class="form-control result_details" name="result_faqus['+afr+'][ans]" aria-describedby="result_faqus" placeholder="Answer" rows="5"></textarea>';
      html+='</td>';
      html+='<td>';
      ...
      $('#form_college_result_faqus_table tbody').append(html);
