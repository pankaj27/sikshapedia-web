...
// var pp='<p><div class="jFiler-items jFiler-row">
//     pp+='<ul class="jFiler-item-list">
//     pp+='<li class="jFiler-item">
//     pp+=' <div class="jFiler-item-container">
//     pp+='<div class="jFiler-item-thumb">
//     pp+='<div class="jFiler-item-status"></div>
//     pp+='<div class="jFiler-item-info">
//     pp+='<span class="jFiler-item-title"><b title="image_2020_06_13T15_41_11_672Z.png">image_2020_06_13T15_41...</b></span>
//     pp+='</div>
//     pp+='<div class="jFiler-item-thumb-image">
//     pp+='<img src="" draggable="false">
//     pp+='</div>
//     pp+='</div>
//     pp+='<div class="jFiler-item-assets jFiler-row">
//     pp+='<ul class="list-inline pull-left">
//                               <li>
//                                 <div class="jFiler-jProgressBar" style="display: block;">
//                                   <div class="bar" style="width: 100%;"></div>
//                                 </div>
//                                 <div class="jFiler-item-others text-success" style=""><i class="icon-jfi-check-circle"></i> Success</div>
//                               </li>
//                             </ul>
//                             <ul class="list-inline pull-right" style="display: none;">
//                               <li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li>
//                               <li><a class="icon-jfi-cloud-up-o jFiler-item-trash-action"></a></li>
//                             </ul>
//                           </div>
//                         </div>
//                       </li>
