jQuery(function($) {
  ...
  var input = document.querySelector("#otp_send_mobile_no");
  window.intlTelInput(input, {
    initialCountry: "in"
  });


  var input2 = document.querySelector("#motp_send_mobile_no");
  ...
  $('#form_register_otp').validate({
    ...
    submitHandler:function(){
      ...
      $.ajax({
        ...
        data:{registration_otp:$('#registration_otp').val(),registration_user:$('#registration_user').val(),review_link:review_link,csrf_test_name:csrf_hash},
        beforeSend:function(){
        ...
        success:function(d){
          if(d.success){
            ...
            if (reviewLinkExists) {
                // The review_link exists in localStorage
                window.localStorage.removeItem('review_link');
            }
