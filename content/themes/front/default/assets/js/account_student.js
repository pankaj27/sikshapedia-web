jQuery(function($) {
  ...
  if( $("#_register_student_country")){
     $("#_register_student_country").chosen({no_results_text: "Select Country"});
  }
  ...
  setTimeout(function(){
    ...
    $('body').on('change','#_register_student_country',function(){
      var country=$('#_register_student_country :selected').val();
      loadstates(country);
    });

    $('body').on('change','#register_student_state',function(){

      var ccode=$('#_register_student_country :selected').val();
      // const myArr = ccode.split("#");
      // var country=myArr[0];
  ...
  $('#form_student_verify_otp2').validate({
    ...
    submitHandler:function(){
      ...
      $.ajax({
        ...
        data:{csrf_test_name:csrf_hash,temp:temp,register_ph_otp:ph_otp,review_link:review_link},
        beforeSend:function(){
  ...
  $('#form_student_register_1').validate({
    validClass: "success",
    rules:{
