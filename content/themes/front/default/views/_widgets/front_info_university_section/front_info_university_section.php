...
<div class="card infoCard mb-4">
  <div class="card-header bg-white d-sm-flex justify-content-between align-items-center">
    <div class="media">
      <a href="#" class="mr-3 "><img class="img-circle" src="<?php echo $college_intro_data['info_curator_image'];?>" width="60" alt="<?php echo $college_intro_data['info_curator'];?>" draggable="false" loading="lazy"></a>
