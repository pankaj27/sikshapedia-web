		...
		<ul class="list-group list-group-flush">
			...
			foreach ($news_data as $key => $value) {
				...
				<li class="list-group-item">
				    <a href="<?php echo $value['news_link'];?>" class="media">
				      <img src="<?php echo $value['news_image'];?>" width="40" class="mr-2" alt="<?php echo $value['news_short_title'];?>"> 
				      <div class="media-body">
				        <h6 class="text-truncate mb-0 color2"><?php echo $value['news_short_title'];?></h6>
