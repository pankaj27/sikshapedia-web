...
if(!empty($college_data)){
	...
	//if($college_data['college_has_verified_badge']=='yes'){
		...
		<?php
		if(!empty($college_data['college_whatsapp_link'])){
			?>
			<a href="<?php echo $college_data['college_whatsapp_link'];?>" class="btn btn-lg btn-primary btn-wati mb-3 btn-block  d-flex justify-content-between align-items-center mobile-call-whatsapp-btn" data-aut_source="whatsapp_button"><span>WHATSAPP NOW </span> <i class="fab fa-whatsapp"></i></a>
			<?php
		}else{
			?>
