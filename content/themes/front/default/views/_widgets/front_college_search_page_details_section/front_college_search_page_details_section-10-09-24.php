...
if(!empty($page_data)){
  ?>
  <div class="card infoCard mb-4" style="margin-top:0px;">
      ...
      if(!empty($page_faq_data)){
        ...
        <div id="accordionExample1" class="accordion">
          ...
          foreach ($page_faq_data as $key => $value) {
            ?>
            <div class="card br-0">
              <a href="#" data-toggle="collapse" data-target="#collapse<?php echo $i;?>" aria-expanded="true" aria-controls="collapse<?php echo $i;?>" class="card-header d-block position-relative text-dark text-uppercase collapsible-link "><strong></strong><?php echo $value->page_data_heading;?></a>
