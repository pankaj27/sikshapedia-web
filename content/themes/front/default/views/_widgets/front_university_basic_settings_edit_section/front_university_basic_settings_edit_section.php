	...
	<div class="col-lg-12 mb-4 mb-lg-0" id="gallery_tabs">
		<div class="card userCard">
			<div class="card-header bg-white">
			  <h5 class="m-0 d-inline">University Basic Informations</h5> <small id="user_type" class="form-text text-muted">Update university basic details</small>
			</div>
			<div class="card-body">
					...
					<form id="form_basic_info_settings" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="form-group col-sm-12">
				                <label>University Name <small class="form-text text-muted">(user will view & appear in search)</small></label>
				                <input type="text" class="form-control" id="register_institute_name" name="register_institute_name" aria-describedby="register_institute_name" placeholder="University Name" value="<?php echo (isset($university_profile_data->university_name))?$university_profile_data->university_name:'';?>">
				            </div>
				        </div>
				        ...
				        <div class="row">
				        	<div class="form-group col-sm-6">
		                      ...
		                      <input type="text" class="form-control" id="register_institute_email" name="register_institute_email" placeholder="Enter Official Email" value="<?php echo (isset($university_profile_data->university_email))?$university_profile_data->university_email:'';?>">
		                  	</div>
		                  	<div class="form-group col-sm-6">
		                      <label>University Phone no <span class="span_star">(*)</span></label>
		                      <input type="text" class="form-control" id="register_institute_phone_no" name="register_institute_phone_no" aria-describedby="register_institute_phone_no" placeholder="Enter Official Phone No." value="<?php echo (isset($university_profile_data->university_phone_no))?$university_profile_data->university_phone_no:'';?>">
		                  	</div>
				        </div>

				        <div class="row">
		                  	<div class="form-group col-sm-6">
		                      <label>University Alternate Phone no </label>
		                      <input type="text" class="form-control" id="register_institute_alter_phone_no" name="register_institute_alter_phone_no" aria-describedby="register_institute_alter_phone_no" placeholder="Enter Official Alternate Phone No." value="<?php echo (isset($university_profile_data->university_alter_phone_no))?$university_profile_data->university_alter_phone_no:'';?>">
		                  	</div>
		                  	<div class="form-group col-sm-6">
		                      <label>University Web Address <span class="span_star">(*)</span></label>
		                      <input type="text" class="form-control" id="register_institute_web_address" name="register_institute_web_address" placeholder="Enter Official Webaddress" value="<?php echo (isset($university_profile_data->university_web_address))?$university_profile_data->university_web_address:'';?>">
		                  	</div>
				        </div>

				        <div class="row">
				        	<div class="form-group col-sm-6">
				        		<label>University Estd. Year</label>
				                <input type="text" class="form-control" id="register_institute_estd" name="register_institute_estd" aria-describedby="register_institute_estd" placeholder="University Estd. Year" value="<?php echo (isset($university_profile_data->university_estd_year))?$university_profile_data->university_estd_year:'';?>">
				        	</div>
				        	<div class="form-group col-sm-6">
				        ...
				        <div class="row">
				        	<div class="form-group col-sm-12">
			                    ...
			                    <label for="inputState">University Grades <span class="span_star">(*)</span></label><br>
			                    <?php
			            ...
			            <div class="row">
			            	<div class="form-group col-sm-6">
			            		...
			            		<input type="text" class="form-control" id="register_institute_zip_code" name="register_institute_zip_code" aria-describedby="register_institute_zip_code" placeholder="Enter Zipcode" value="<?php echo (isset($university_profile_data->university_zipcode))?$university_profile_data->university_zipcode:'';?>">
			            	</div>
			            	<div class="form-group col-sm-6">
			            		<label for="inputState">Address <span class="span_star">(*)</span></label>
			            		<textarea class="form-control" name="register_institute_address" id="register_institute_address" rows="3" aria-hidden="true"><?php echo (isset($university_profile_data->university_address))?$university_profile_data->university_address:'';?></textarea>
			            	</div>
			            </div>
			            ...
			            <div class="row">
							<div class="form-group col-sm-12">
								<label class="control-label"><strong>Brief Description About University</strong><small class="form-text text-muted">(will help user to grow their interests.more info will engage them to your college.)</small></label>
						...
						<div class="row">
							<div class="form-group col-sm-12">
								<label class="control-label"><strong>Broad Description About University</strong><small class="form-text text-muted">(will help user to grow their interests.more info will engage them to your college.)</small></label>
