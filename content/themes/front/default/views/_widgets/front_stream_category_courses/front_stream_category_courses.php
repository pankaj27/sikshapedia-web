...
if(!empty($courses)){
	...
	foreach ($courses as $k => $v) {
		?>
		<div class="tab-pane fade <?php echo ($i==0)?'show active':'';?>" id="nav-<?php echo $k;?>" role="tabpanel" aria-labelledby="nav-<?php echo $k;?>-tab">
	      <?php
        $i=1;
    					...
    					<div class="card mb-3">
    					    <div class="card-body">
    					        <div class="row">
    					          <div class="col-md-9">
    					              <h5 class="text-uppercase">
    					                  ...
    					                  if(!empty($value['course_url'])){
    					                      ?>
    					                      <a href="<?php echo $value['course_url'];?>"><?php echo $value['courses_data_type_value'];?></a>
    					                      <?php
    					                  }else{
    					                       echo $value['courses_data_type_value'];
    					                  }
    					                  ?>
    					              ...
    					              if($value['course_duration_type']!=null && $value['course_duration']!=''){
    					                  if($value['course_duration']>0){
    					                      ...
    					                      ?>
    					              	        <div><span class="color1"><span class="color2"> <?php echo $value['course_duration_type'];?> </span></div>
    					              	        <?php
    					                  }
    					          ...
    					          <?php
    					          if(!empty($value['course_offerd_total_colleges'])){
    					          	?>
    				          		<div class="col-md-3 text-right">
    					              <h2 class="color2"><?php echo $value['course_offerd_total_colleges'];?></h2>
