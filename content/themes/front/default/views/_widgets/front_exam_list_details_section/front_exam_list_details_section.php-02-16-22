	...
	if(!empty($exams_list)){
		...
		foreach ($exams_list as $key => $value) {
			...
			foreach ($value as $k => $v) {
		                    ...
		                    <div class="col-sm-6">
		                        <div class="media">
		                            ...
		                            <div class="media-body">
		                            	...
		                            	?>
		                              <h6 class="mt-0 mb-1" style="font-size: 26.7px;font-weight: 900;"> <a href="<?php echo $v['exam_link'];?>" style="color: #4d586c;"><?php echo $v['exam_year_short_name'];?></a></h6>
		                        	...
		                        	if(!empty($v['exam_application_form_dates'])){
		                        		...
		                        		<div class="col">
			                                <div class="examDatesInfo">
			                                    ...
			                                    <p class="m-0"><small><?php echo $v['exam_application_form_dates']['start_date'];?> - <?php echo $v['exam_application_form_dates']['end_date'];?></small> </p>
		            ...
		            if(!empty($v['exam_menues'])){
		            	...
		            	<div class="card-footer bg-white">
		            		...
		            		foreach ($v['exam_menues'] as $_k => $_v) {
		            			?>
		            			<a href="<?php echo $_v['menu_link'];?>" class="btn btn-light btn-sm" style="color:#f57b32"><strong><?php echo $_v['menu_name'];?></strong></a>
		            			<?php
		            		}
		            		?>
				...
				?>
				<div class="adBlock" style="margin-top: 20px; margin-bottom:0px;">      
