...
<section class="headerBnrSec">
    <img src="<?php echo $university_data['university_banner'];?>" class="headerBnrImg">
    <div class="wrapper">
	    <div class="headerBnrPanel">
	        <div class="bnrThumbBox">
	          <div class="bnrThumb shadow bg-white"><img src="<?php echo $university_data['university_logo'];?>"></div>
	          <div class="bnrThumbCon">
	            <h5 class="m-0"><?php echo $university_data['university_name'];?></h5>
				<p class="m-0 d-none d-lg-block"><i class="fas fa-envelope"></i> <?php echo $university_data['university_email'];?></p>	            
	          </div>
	        </div>
