      ...
      <div class="eaxmBannerContent">
          <div class="wrapper">
              ...
              <div class="searchPanelBox">
                  ...
                  <form>
                     <div class="searchPanel" id="examSearch">              
                         <div class="searchBox"><input type="text" class="keyword" placeholder="Search Entrance Exams" autocomplete="off" id="search_exams" onkeyup="_searchExams()" onkeydown="_searchExams()" onpaste="_searchExams()"><span class="searchIcon"></span></div>
                  </div>
                  </form>
              </div>
