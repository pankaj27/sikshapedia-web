<div class="row" id="div_step9">
  ...
  <div class="col-lg-10">
    <form id="review_form_step_11" class="review_form" autocomplete="off" novalidate style="width:100%;">
        ...
        <div class="card userCard mb-4">
          ...
          <div class="card-body">                  
            ...
            <div class="row">
              <div class="form-group col-sm-12">
                    <div class=" ques-div">
                      <p class=" mb-1 ques-head"></p>
                      <p class=" font-weight-bold mb-2 ques-subhead">
                      You Agree that you will not:</p>
                    </div>
                    <div class="">
                      <div class=" points">
                        <div class="">
                          <p class=" point-text">Impersonate another person or his or her email address, or misrepresent your current or former affiliation with an institution.</p>
                        </div>
                        <div class="">
                          <p class=" point-text">Create user accounts under false or fraudulent pretences, create or use an account for anyone other than yourself.</p>
                        </div>
                        <div class="">
                          <p class=" point-text">Post content that is defamatory, libelous or fraudulent, that you know to be false or misleading or that does not reflect your honest.</p>
                        </div>
                      </div>
                    </div>
    ...
    $('#review_form_step_11').validate({
      ...
      submitHandler:function(f){
        $.ajax({
          ...
          data:$('#review_form_step_11').serialize(),
          beforeSend:function(){
