<div class="row" id="div_step2">
    ...
    <div class="col-lg-8">
  <form id="review_form_step_3" class="review_form" autocomplete="off" novalidate style="width:100%;">
    ...
    <input type="hidden" name="<?php echo $csrf['name'];?>" value="<?php echo $csrf['hash'];?>">
      ...
      <div class="card userCard mb-4">
        <div class="card-header bg-white">
          <h4 class="m-0 d-inline">Step 3 - Course Curriculam & Faculty info</h4>
        ...
        <div class="card-body">                  
          <div class="row">
              <div class="form-group col-sm-12">
                  <div class="jsx-2879957041 ques-div">
                    ...
                    Q2. How is the course curriculam & faculty members?</p>
                    <p class="jsx-2879957041 font-weight-bold mb-2 ques-subhead">
                    What to include?</p>
                  </div>
                  <div class="jsx-2879957041">
                    <div class="jsx-2879957041 points">
                      <div class="jsx-2879957041">
                        <p class="jsx-2879957041 point-text">Mention why did you choose the course</p>
                      </div>
                      <div class="jsx-2879957041">
                          <p class="jsx-2879957041 point-text">A brief about faculty student ratio</p>
                        </div>
                        <div class="jsx-2879957041">
                          <p class="jsx-2879957041 point-text">Qualification of the faculty & review teaching method</p>
                        </div>
                        <div class="jsx-2879957041"><p class="jsx-2879957041 point-text">How timely was term exams and how diffidult was pass</p>
                        </div>
                      </div>
                    </div>
          ...
          <div class="row">
            <div class="col-lg-12">
            <fieldset class="jsx-4149282442 jsx-497415273 d-block"><div class="jsx-2879957041 ques-div"><p class="jsx-2879957041 mb-1 ques-head">Rate your course & faculty members</p><p class="jsx-2879957041 font-weight-bold mb-2 ques-subhead">Make it accurate considering all pros and cons</p></div><div class="jsx-4149282442 jsx-497415273 undefined"><div class="jsx-4149282442 jsx-497415273"></div><fieldset class="jsx-4028593834 rating-input "><p class="jsx-4028593834 mb-1 ques-head"></p><p class="jsx-4028593834 font-weight-bold"></p><div class="jsx-4028593834 rating"><div class="jsx-4028593834 d-flex justify-content-between"><p class="jsx-4028593834 m-0 rating-txt">Not at all Likely</p><p class="jsx-4028593834 m-0 rating-txt">Extremely Likely</p></div>
        ...
        <div class="card-footer">
          ...
          <div class="row">
            <div class="col-lg-6">
                     <button class="btn btn-primary " type="button" id="prev_point" data-point="step_2"> Previous</button>
            </div>
            <div class="col-lg-6">
    ...
    $('#review_form_step_3').validate({
      ...
      submitHandler:function(f){
        $.ajax({
          ...
          data:$('#review_form_step_3').serialize(),
          beforeSend:function(){
