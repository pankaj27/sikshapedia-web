    ...
    <input type="hidden" name="<?php echo $csrf['name'];?>" value="<?php echo $csrf['hash'];?>">
      ...
      <div class="card userCard mb-4">
        ...
        <div class="card-body">                  
          ...
          <div class="row">
            <div class="col-lg-12">
            <fieldset class="jsx-4149282442 jsx-497415273 d-block"><div class="jsx-2879957041 ques-div"><p class="jsx-2879957041 mb-1 ques-head">How do you rate your college on overall experience?</p><p class="jsx-2879957041 font-weight-bold mb-2 ques-subhead">Make it accurate considering all pros and cons</p></div><div class="jsx-4149282442 jsx-497415273 undefined"><div class="jsx-4149282442 jsx-497415273"></div>
              <fieldset class="jsx-4028593834 rating-input "><p class="jsx-4028593834 mb-1 ques-head"></p><p class="jsx-4028593834 font-weight-bold"></p><div class="jsx-4028593834 rating"><div class="jsx-4028593834 d-flex justify-content-between"><p class="jsx-4028593834 m-0 rating-txt">Not at all Likely</p><p class="jsx-4028593834 m-0 rating-txt">Extremely Likely</p></div>
