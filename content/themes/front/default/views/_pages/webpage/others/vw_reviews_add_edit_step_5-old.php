<div class="row" id="div_step5">
    <div class="col-lg-2"></div>
    <div class="col-lg-8">
      <form id="review_form_step_5" class="review_form" autocomplete="off" novalidate style="width:100%;">
        ...
        <input type="hidden" name="review_question" value="Did you face any Group Discussion,Interview or Written Test for the admission?">
        <input type="hidden" name="<?php echo $csrf['name'];?>" value="<?php echo $csrf['hash'];?>">
        
          <div class="card userCard mb-4">
            <div class="card-header bg-white">
              <h4 class="m-0 d-inline">Step 5 - Admission Process & Exam Info</h4>
              ...
              <div class="row">
                  <div class="form-group col-sm-12">
                      <div class="jsx-2879957041 ques-div">
                        ...
                        Q4. Did you face any Group Discussion,Interview or Written Test for the admission?</p>
                        <p class="jsx-2879957041 font-weight-bold mb-2 ques-subhead">
                        What to include?</p>
                      </div>
                      <div class="jsx-2879957041">
                        <div class="jsx-2879957041 points">
                            <div class="jsx-2879957041">
                              <p class="jsx-2879957041 point-text">What were the topics of the GD,Interview question or test pattern</p>
                            </div>
                            <div class="jsx-2879957041">
                              <p class="jsx-2879957041 point-text">Discuss the process and other criteria for admission</p>
                            </div>
                            <div class="jsx-2879957041">
                              <p class="jsx-2879957041 point-text">How did you prepare for these rounds</p>
                            </div>
                          </div>
                        </div>
            ...
            <div class="card-footer">
                ...
                <div class="row">
                    <div class="col-lg-6">
                           <button class="btn btn-primary " type="button" id="prev_point" data-point="step_4"> Previous</button>
                    </div>
                    <div class="col-lg-6">
    ...
    $('#review_form_step_5').validate({
      ...
      submitHandler:function(f){
        $.ajax({
          ...
          data:$('#review_form_step_5').serialize(),
          beforeSend:function(){
