...
<div class="modal reviewCollegeSearckModal" id="reviewCollegeSearckModal" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        if(!empty($data_searched)){
          foreach ($data_searched as $key => $value) {
            ...
            <div class="col-6 d-flex text-lg hover-primary mb-6 pointer">
              ...
              <span class="jsx-1879175554 pl-3"><a class="college_review_link" data-reviewlink="<?php echo $value['inst_review_link'];?>"><?php echo $value['inst_name'];?></a></span>
            </div>
            <?php
          }
        }
