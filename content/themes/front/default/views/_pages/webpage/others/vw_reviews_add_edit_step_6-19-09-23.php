 <div class="row" id="div_step6">
    ...
    <div class="col-lg-8">
      <form id="review_form_step_6" class="review_form" autocomplete="off" novalidate style="width:100%;">
        ...
        <input type="hidden" name="review_course" value="<?php echo $review_data['review_course_id'];?>">
              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="feedback__body">
                    <p> <span class="name name--company u-text--custom">How would you Rate your Interview experience?</span></p>
