    ...
    <div class="wrapper">
      ...
      <div class="reviewSearchBox">
        <div class="searchPanel">                
        	<div class="searchBox">
        		<input type="text" class="keyword" placeholder="Search Your College and Start Writing" id="review_college_name" autocomplete="off"><span class="searchIcon"></span>
        	</div>
        	<ul class="suggestList nicescroll" id="ul_college_list">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
  	...
  	// const collegeList = $('ul#ul_college_list');

  	// function onsearch_review_colleges(_c,_cp){
  		
  	// 	$.ajax({
	  //       type:'GET',
	  //       url:base_url+'reviews/load_steps_review?_cp='+_cp+'&_c='+_c,
	  //       dataType: 'json',
	  //       success:function(d){

	  //         	if(d.colleges){
	            
		//            $.each(d.colleges,function(i,v){
		//            	html+='<li><a href="'+v['data_review_link']+'">'+v['data_formatted_name']+'</a></li>';
		//            });
	  //         	}
    ...
    //   	});
  	...
  	// 	onsearch_review_colleges(query);
