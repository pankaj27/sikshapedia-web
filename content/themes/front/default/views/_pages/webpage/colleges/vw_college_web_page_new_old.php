...
<section class="headerBnrSec overlayBnr">
    ...
    <div class="wrapper">
      <div class="headerBnrPanel">
        <div class="bnrThumbBox">
          <div class="bnrThumb shadow bg-white"><img src="<?php echo $college_data['college_logo'];?>"></div>
          <div class="bnrThumbCon pt-2">
            ...
            <h5 class="m-0 bnrTitle text-truncate text-uppercase w-75"><?php echo $college_data['college_name'];?>, <?php echo $college_data['college_city'];?></h5>
            <div class="m-0  d-lg-flex  justify-content-between tagLists w-75">
              <div class="text-truncate tags">
                ...
                <span><i class="fas fa-tags"> </i> KARNATAKA  AICTE </span> 
        ...
        <div class="headerBnrCon d-none d-md-block">
          ...
          <a href="javascript:void(0);" class="btn btn-outline-light btnContact apply" data-cname="<?php echo $college_data['college_name'];?>,<?php echo $college_data['college_city'];?>" data-inst="<?php echo $college_data['college_id'];?>" data-inst_type="<?php echo $college_data['institute_type'];?>" data-clogo="<?php echo $college_data['college_logo'];?>" data-cphcode="<?php echo $college_data['college_country_phone_code'];?>" data-cou="<?php echo $college_data['college_country_id'];?>">GET CONTACT DETAILS</a>
          <a href="#" class="btn btn-link text-white btnclaim"> <i class="fas fa-dot-circle text-warning pals" ></i>  Claim This College</a>
    ...
    <div class="wrapper">
      <div class="row">
        ...
        <div class="col-lg-9 mb-4 mb-lg-0">
          <?php
          if(!empty($college_data['college_page_top_ads'])){
            ?>
            <div class="adBlock ">
               <div id="bodyslot_5" class="bodyslot bodyslot-dynamic clearfix"><div data-ads-id="55107" data-ads-type="banner" data-page-type="global" class="ads_body_banner_container clearfix" wfd-id="7974"><a href="<?php echo $college_data['ads_link'];?>" target="_blank" rel="nofollow" id="ads_viewport_55107" data-id="55107"><img src="<?php echo $college_data['ads_image'];?>"></a></div>
               </div>
            </div>
            <?php
          }
            ...
            <div class="card-header bg-white d-sm-flex justify-content-between align-items-center">
              <div class="media">
                ...
                <div class="media-body">
                  <h5 class="mt-0 text-dark"><a href="#" class="text-dark"> By Swati Mishra  </a> </h5>
          ...
          <?php $this->widget->run('front_info_section',$show_info_widget);?>
          <?php $this->widget->run('front_gallery_section',$show_gallery_widget);?>
          <?php $this->widget->run('front_course_fees_section',$show_course_fees_widget);?>
          <?php $this->widget->run('front_course_fees_course_section',$show_course_fees_course_widget);?>
          
          <?php $this->widget->run('front_similar_colleges_universities_section',$show_similar_colleges_universities_widget);?>
          <?php $this->widget->run('front_nearby_colleges_universities_section',$show_nearby_colleges_universities_widget);?>
          <?php $this->widget->run('front_news_section',$show_news_widget);?>
        </div>



        <div class="col-lg-3 ">
            <a href="" class="btn btn-lg btn-primary mb-3 btn-block  d-flex justify-content-between align-items-center"><span>APPLY NOW </span> <i class="far fa-envelope"></i></a>
  ...
  <script type="text/javascript">let _co='<?php echo $college_data['college_country_id'];?>';</script>