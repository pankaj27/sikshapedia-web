				...
				<div class="card userCard">
		        	...
		        	<div class="card-body">
                    	...
                    	<select class="form-control" name="gallery_category" id="gallery_category">
	              				...
	              				<option value="2">Infrustructure</option>
	              				<option value="3">Campus & facilities</option>
	              				<option value="4">Laboratories</option>
	              				<option value="5">Promotional Videos</option>
	              			</select>
                	  </div>
                  	<div class="form-group col-sm-12">s
                  		...
                  		<div class="custom-file" id="gallery_file_div">
		        			...
		        			<div class="row">
		        				<div class="col-sm-12">
					               <button type="submit" class="btn btn-primary" id="btn_update_gallery">Upload</button>
					            </div>
		        			</div>
		        		</form>
		        	</div>
