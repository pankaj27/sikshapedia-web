			...
			<div class="col-lg-12 mb-4 mb-lg-0" id="gallery_tabs">
				<div class="card userCard">
					<div class="card-header bg-white">
					  <h5 class="m-0 d-inline">College Informations</h5> <small id="user_type" class="form-text text-muted">You need to update your account type to operate your account.Without updating your account type it will be deactivated.</small>
					</div>
					<div class="card-body">
							...
							<form id="form_info_settings" enctype="multipart/form-data">
					            ...
					            <div class="form-group col-sm-6 col-md-4">
					                <label>College University Affiliation</label>


					                <select class="form-control" name="registration_university_affiliation" id="registration_university_affiliation">
					            ...
					            <div class="form-group col-sm-6 col-md-4">
									...
									<div class="custom-file">
									    <input type="file" class="custom-file-input" id="registration_logo" aria-describedby="registration_logo" name="registration_logo" value="<?php echo $user_logo_name;?>">
								...
								<div class="form-group col-sm-6 col-md-4">
									...
									<div class="custom-file">
									    <input type="file" class="custom-file-input" id="registration_banner" name="registration_banner" aria-describedby="registration_banner" value="<?php echo $user_banner_name;?>">
					            ...
					            <div class="form-group col-sm-12">
					                <label class="d-block">College Affiliation</label>
					                <?php
