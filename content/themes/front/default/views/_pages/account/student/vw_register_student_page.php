...
<section class="profile-content py-4 bg-white" style="padding-bottom:20px;">
  ...
  <div class="wrapper wrapper-background">
    <div class="row">
    	<div class="col-lg-6 mb-4 mb-lg-0 mobile-content-left" style="padding-top: 150px;padding-right: 280px;padding-bottom: 150px;padding-left: 50px;top:-80px">
	    ...
	    <div class="col-lg-6 mb-4 mb-lg-0 mobile-content-right" style="padding-top: 150px;padding-right: 50px;padding-bottom: 150px;padding-left: 280px;top:-80px">
	        <div class="card userCard">
	        	<div class="card-body">
                    <div class="row" style="padding-bottom:20px;">
                        <div class="col-lg-12" style="text-align: center;font-weight: bold;">
                            <p class="m-0 d-inline color2 boxheading">REGISTER NOW </p>
                          </div>
                      </div>
                ...
                <div class="row">
                      ...
                      <?php
                        if(!empty($countries)){
                          foreach ($countries as $key => $value) {
                            ?>
                            <option value="<?php echo $value['country_id'];?>" <?php echo (decode_data($value['country_id'])==$country_id)?'selected':'';?>><?php echo $value['country_name'];?></option>
                            <?php
                          }
                        }
                      ?>
                    ...
                    <input type="text" class="form-control" id="register_student_phone_no" name="register_student_phone_no" aria-describedby="register_college_phone_no" placeholder="Enter Phone No." value="<?php echo $phone_no;?>">
                	</div>
                </div>
...
<style type="text/css">
 ...
 .chosen-container .chosen-results {
  ...
  /* custom added media quary */
/* for all small screen size */
/* custom added media quary */
/* for all small screen size */
