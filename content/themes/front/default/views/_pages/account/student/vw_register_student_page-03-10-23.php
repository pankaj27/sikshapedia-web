  ...
  <div class="wrapper">
    <div class="row">
	    ...
	    <div class="col-lg-8 mb-4 mb-lg-0">
	        <div class="card userCard">
	        	<div class="card-header bg-white">
	        	  <h5 class="m-0 d-inline">Register with <?php echo $system_name;?></h5> <small id="user_type" class="form-text text-muted">You need to update your account type to operate your account.Without updating your account type it will be deactivated.</small>
	        	</div>
	        	<div class="card-body">
	        		<div class="row">
			...
			<div class="col-lg-4 mb-4 mb-lg-0">
				<div class="card userCard">
        	<div class="card-header bg-white">
        	  <h5 class="m-0 d-inline">Signin with <?php echo $system_name;?> credentials .</h5>
        	</div>
        	<div class="card-body">
        		<div class="row">
				...
				<!-- way_to_vrt_03102021_01 -->
				<ins class="adsbygoogle"
					style="display:block"
					data-ad-client="ca-pub-9545373166119354"
					data-ad-slot="8697297495"
					data-ad-format="auto"
