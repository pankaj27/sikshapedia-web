...
if(!empty($searched_universities)){
  foreach ($searched_universities as $key => $value) {
    ...
    <div class="col-sm-6 col-md-4 col-lg-4">
        <div class="proBox">
          <div class="imgBox">
            <a href="#"> <img src="<?php echo $value['university_banner'];?>" alt="<?php echo $value['university_name'];?>"></a>
          ...
          <div class="proBoxBody">
            <div class="proInfo">
              <div class="infoImg"><a href="<?php echo $value['access_url'];?>"><img src="<?php echo $value['university_logo'];?>"></a></div>
